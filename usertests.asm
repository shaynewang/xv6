...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	c7 44 24 04 6a 45 00 	movl   $0x456a,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 6a 41 00 00       	call   4185 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 75 45 00 00 	movl   $0x4575,(%esp)
      22:	e8 06 40 00 00       	call   402d <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 a8 64 00 00       	mov    0x64a8,%eax
      30:	c7 44 24 04 7d 45 00 	movl   $0x457d,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 45 41 00 00       	call   4185 <printf>
    exit();
      40:	e8 80 3f 00 00       	call   3fc5 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 75 45 00 00 	movl   $0x4575,(%esp)
      4c:	e8 e4 3f 00 00       	call   4035 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 a8 64 00 00       	mov    0x64a8,%eax
      5a:	c7 44 24 04 8b 45 00 	movl   $0x458b,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 1b 41 00 00       	call   4185 <printf>
    exit();
      6a:	e8 56 3f 00 00       	call   3fc5 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 a1 45 00 00 	movl   $0x45a1,(%esp)
      76:	e8 9a 3f 00 00       	call   4015 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 a8 64 00 00       	mov    0x64a8,%eax
      84:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 f1 40 00 00       	call   4185 <printf>
    exit();
      94:	e8 2c 3f 00 00       	call   3fc5 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 c6 45 00 00 	movl   $0x45c6,(%esp)
      a0:	e8 90 3f 00 00       	call   4035 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 a8 64 00 00       	mov    0x64a8,%eax
      ae:	c7 44 24 04 c8 45 00 	movl   $0x45c8,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 c7 40 00 00       	call   4185 <printf>
    exit();
      be:	e8 02 3f 00 00       	call   3fc5 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 a8 64 00 00       	mov    0x64a8,%eax
      c8:	c7 44 24 04 d8 45 00 	movl   $0x45d8,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 ad 40 00 00       	call   4185 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e5:	c7 44 24 04 e6 45 00 	movl   $0x45e6,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 90 40 00 00       	call   4185 <printf>

  pid = fork();
      f5:	e8 c3 3e 00 00       	call   3fbd <fork>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     108:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 6d 40 00 00       	call   4185 <printf>
    exit();
     118:	e8 a8 3e 00 00       	call   3fc5 <exit>
  }
  if(pid == 0){
     11d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     121:	0f 85 83 00 00 00    	jne    1aa <exitiputtest+0xd0>
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 75 45 00 00 	movl   $0x4575,(%esp)
     12e:	e8 fa 3e 00 00       	call   402d <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 a8 64 00 00       	mov    0x64a8,%eax
     13c:	c7 44 24 04 7d 45 00 	movl   $0x457d,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 39 40 00 00       	call   4185 <printf>
      exit();
     14c:	e8 74 3e 00 00       	call   3fc5 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 75 45 00 00 	movl   $0x4575,(%esp)
     158:	e8 d8 3e 00 00       	call   4035 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 a8 64 00 00       	mov    0x64a8,%eax
     166:	c7 44 24 04 02 46 00 	movl   $0x4602,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 0f 40 00 00       	call   4185 <printf>
      exit();
     176:	e8 4a 3e 00 00       	call   3fc5 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 a1 45 00 00 	movl   $0x45a1,(%esp)
     182:	e8 8e 3e 00 00       	call   4015 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 a8 64 00 00       	mov    0x64a8,%eax
     190:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 e5 3f 00 00       	call   4185 <printf>
      exit();
     1a0:	e8 20 3e 00 00       	call   3fc5 <exit>
    }
    exit();
     1a5:	e8 1b 3e 00 00       	call   3fc5 <exit>
  }
  wait();
     1aa:	e8 1e 3e 00 00       	call   3fcd <wait>
  printf(stdout, "exitiput test ok\n");
     1af:	a1 a8 64 00 00       	mov    0x64a8,%eax
     1b4:	c7 44 24 04 16 46 00 	movl   $0x4616,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 c1 3f 00 00       	call   4185 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d1:	c7 44 24 04 28 46 00 	movl   $0x4628,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 a4 3f 00 00       	call   4185 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 37 46 00 00 	movl   $0x4637,(%esp)
     1e8:	e8 40 3e 00 00       	call   402d <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 a8 64 00 00       	mov    0x64a8,%eax
     1f6:	c7 44 24 04 3d 46 00 	movl   $0x463d,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 7f 3f 00 00       	call   4185 <printf>
    exit();
     206:	e8 ba 3d 00 00       	call   3fc5 <exit>
  }
  pid = fork();
     20b:	e8 ad 3d 00 00       	call   3fbd <fork>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     21e:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 57 3f 00 00       	call   4185 <printf>
    exit();
     22e:	e8 92 3d 00 00       	call   3fc5 <exit>
  }
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 37 46 00 00 	movl   $0x4637,(%esp)
     248:	e8 b8 3d 00 00       	call   4005 <open>
    ...
    if(fd >= 0){
     ...
     25b:	c7 44 24 04 54 46 00 	movl   $0x4654,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 1a 3f 00 00       	call   4185 <printf>
      exit();
     26b:	e8 55 3d 00 00       	call   3fc5 <exit>
    }
    exit();
     270:	e8 50 3d 00 00       	call   3fc5 <exit>
  }
  sleep(1);
     275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     27c:	e8 d4 3d 00 00       	call   4055 <sleep>
  if(unlink("oidir") != 0){
     281:	c7 04 24 37 46 00 00 	movl   $0x4637,(%esp)
     288:	e8 88 3d 00 00       	call   4015 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 a8 64 00 00       	mov    0x64a8,%eax
     296:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 df 3e 00 00       	call   4185 <printf>
    exit();
     2a6:	e8 1a 3d 00 00       	call   3fc5 <exit>
  }
  wait();
     2ab:	e8 1d 3d 00 00       	call   3fcd <wait>
  printf(stdout, "openiput test ok\n");
     2b0:	a1 a8 64 00 00       	mov    0x64a8,%eax
     2b5:	c7 44 24 04 87 46 00 	movl   $0x4687,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 c0 3e 00 00       	call   4185 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2d2:	c7 44 24 04 99 46 00 	movl   $0x4699,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 a3 3e 00 00       	call   4185 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 54 45 00 00 	movl   $0x4554,(%esp)
     2f1:	e8 0f 3d 00 00       	call   4005 <open>
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     304:	c7 44 24 04 a4 46 00 	movl   $0x46a4,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 71 3e 00 00       	call   4185 <printf>
    exit();
     314:	e8 ac 3c 00 00       	call   3fc5 <exit>
  }
  close(fd);
     319:	8b 45 f4             	mov    -0xc(%ebp),%eax
     31c:	89 04 24             	mov    %eax,(%esp)
     31f:	e8 c9 3c 00 00       	call   3fed <close>
  fd = open("doesnotexist", 0);
     324:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     32b:	00 
     32c:	c7 04 24 b7 46 00 00 	movl   $0x46b7,(%esp)
     333:	e8 cd 3c 00 00       	call   4005 <open>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     346:	c7 44 24 04 c4 46 00 	movl   $0x46c4,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 2f 3e 00 00       	call   4185 <printf>
    exit();
     356:	e8 6a 3c 00 00       	call   3fc5 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 a8 64 00 00       	mov    0x64a8,%eax
     360:	c7 44 24 04 e2 46 00 	movl   $0x46e2,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 15 3e 00 00       	call   4185 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     37d:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
     384:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     394:	00 
     395:	c7 04 24 01 47 00 00 	movl   $0x4701,(%esp)
     39c:	e8 64 3c 00 00       	call   4005 <open>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3af:	c7 44 24 04 07 47 00 	movl   $0x4707,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 c6 3d 00 00       	call   4185 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d0:	c7 44 24 04 22 47 00 	movl   $0x4722,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 a5 3d 00 00       	call   4185 <printf>
    exit();
     3e0:	e8 e0 3b 00 00       	call   3fc5 <exit>
  }
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     3e5:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     3ec:	00 
     3ed:	c7 44 24 04 3e 47 00 	movl   $0x473e,0x4(%esp)
     3f4:	00 
     3f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
     3f8:	89 04 24             	mov    %eax,(%esp)
     3fb:	e8 e5 3b 00 00       	call   3fe5 <write>
     ...
     411:	c7 44 24 04 4c 47 00 	movl   $0x474c,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 64 3d 00 00       	call   4185 <printf>
      exit();
     421:	e8 9f 3b 00 00       	call   3fc5 <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     426:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     42d:	00 
     42e:	c7 44 24 04 70 47 00 	movl   $0x4770,0x4(%esp)
     435:	00 
     436:	8b 45 f0             	mov    -0x10(%ebp),%eax
     439:	89 04 24             	mov    %eax,(%esp)
     43c:	e8 a4 3b 00 00       	call   3fe5 <write>
     ...
     452:	c7 44 24 04 7c 47 00 	movl   $0x477c,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 23 3d 00 00       	call   4185 <printf>
      exit();
     462:	e8 5e 3b 00 00       	call   3fc5 <exit>
    printf(stdout, "creat small succeeded; ok\n");
  } else {
    printf(stdout, "error: creat small failed!\n");
    exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     47a:	c7 44 24 04 a0 47 00 	movl   $0x47a0,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 fb 3c 00 00       	call   4185 <printf>
  close(fd);
     48a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     48d:	89 04 24             	mov    %eax,(%esp)
     490:	e8 58 3b 00 00       	call   3fed <close>
  fd = open("small", O_RDONLY);
     495:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     49c:	00 
     49d:	c7 04 24 01 47 00 00 	movl   $0x4701,(%esp)
     4a4:	e8 5c 3b 00 00       	call   4005 <open>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4b7:	c7 44 24 04 ab 47 00 	movl   $0x47ab,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 be 3c 00 00       	call   4185 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4dd:	e8 fb 3a 00 00       	call   3fdd <read>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4f5:	c7 44 24 04 c4 47 00 	movl   $0x47c4,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 80 3c 00 00       	call   4185 <printf>
    exit();
     505:	e8 bb 3a 00 00       	call   3fc5 <exit>
  }
  i = read(fd, buf, 2000);
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 a8 64 00 00       	mov    0x64a8,%eax
     50f:	c7 44 24 04 df 47 00 	movl   $0x47df,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 66 3c 00 00       	call   4185 <printf>
  } else {
  ...
  close(fd);
     ...
     525:	e8 c3 3a 00 00       	call   3fed <close>

  if(unlink("small") < 0){
     52a:	c7 04 24 01 47 00 00 	movl   $0x4701,(%esp)
     531:	e8 df 3a 00 00       	call   4015 <unlink>
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     541:	c7 44 24 04 f2 47 00 	movl   $0x47f2,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 34 3c 00 00       	call   4185 <printf>
    exit();
     551:	e8 6f 3a 00 00       	call   3fc5 <exit>
  }
  close(fd);
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     55b:	c7 44 24 04 ff 47 00 	movl   $0x47ff,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 1a 3c 00 00       	call   4185 <printf>
    exit();
     56b:	e8 55 3a 00 00       	call   3fc5 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 a8 64 00 00       	mov    0x64a8,%eax
     575:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 00 3c 00 00       	call   4185 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     592:	c7 44 24 04 28 48 00 	movl   $0x4828,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 e3 3b 00 00       	call   4185 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
     5b1:	e8 4f 3a 00 00       	call   4005 <open>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     5c4:	c7 44 24 04 3c 48 00 	movl   $0x483c,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 b1 3b 00 00       	call   4185 <printf>
    exit();
     5d4:	e8 ec 39 00 00       	call   3fc5 <exit>
  }
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     602:	e8 de 39 00 00       	call   3fe5 <write>
     ...
     61a:	c7 44 24 04 56 48 00 	movl   $0x4856,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 5b 3b 00 00       	call   4185 <printf>
      exit();
     62a:	e8 96 39 00 00       	call   3fc5 <exit>
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
    exit();
  }
  ...
  close(fd);
     ...
     643:	e8 a5 39 00 00       	call   3fed <close>

  fd = open("big", O_RDONLY);
     648:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     64f:	00 
     650:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
     657:	e8 a9 39 00 00       	call   4005 <open>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     66a:	c7 44 24 04 74 48 00 	movl   $0x4874,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 0b 3b 00 00       	call   4185 <printf>
    exit();
     67a:	e8 46 39 00 00       	call   3fc5 <exit>
  }
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     69c:	e8 3c 39 00 00       	call   3fdd <read>
    ...
    if(i == 0){
     ...
     6bf:	c7 44 24 04 8d 48 00 	movl   $0x488d,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 b6 3a 00 00       	call   4185 <printf>
        exit();
     6cf:	e8 f1 38 00 00       	call   3fc5 <exit>
      }
      break;
     6d4:	90                   	nop
             n, ((int*)buf)[0]);
  ...
  close(fd);
     ...
     6db:	e8 0d 39 00 00       	call   3fed <close>
  if(unlink("big") < 0){
     6e0:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
     6e7:	e8 29 39 00 00       	call   4015 <unlink>
     ...
     70b:	c7 44 24 04 aa 48 00 	movl   $0x48aa,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 6a 3a 00 00       	call   4185 <printf>
      exit();
     71b:	e8 a5 38 00 00       	call   3fc5 <exit>
    }
    if(((int*)buf)[0] != n){
    ...
    if(((int*)buf)[0] != n){
     ...
     743:	c7 44 24 04 bc 48 00 	movl   $0x48bc,0x4(%esp)
     74a:	00 
     74b:	89 04 24             	mov    %eax,(%esp)
     74e:	e8 32 3a 00 00       	call   4185 <printf>
             n, ((int*)buf)[0]);
      exit();
     753:	e8 6d 38 00 00       	call   3fc5 <exit>
    }
    n++;
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     766:	c7 44 24 04 dc 48 00 	movl   $0x48dc,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 0f 3a 00 00       	call   4185 <printf>
    exit();
     776:	e8 4a 38 00 00       	call   3fc5 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 a8 64 00 00       	mov    0x64a8,%eax
     780:	c7 44 24 04 ef 48 00 	movl   $0x48ef,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 f5 39 00 00       	call   4185 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     79d:	c7 44 24 04 00 49 00 	movl   $0x4900,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 d8 39 00 00       	call   4185 <printf>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     824:	e8 ec 37 00 00       	call   4015 <unlink>
    fd = open(name, O_CREATE|O_RDWR);
    close(fd);
  }
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     838:	c7 44 24 04 28 49 00 	movl   $0x4928,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 3d 39 00 00       	call   4185 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     855:	c7 44 24 04 4e 49 00 	movl   $0x494e,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 20 39 00 00       	call   4185 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
     86c:	e8 bc 37 00 00       	call   402d <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 a8 64 00 00       	mov    0x64a8,%eax
     87a:	c7 44 24 04 7d 45 00 	movl   $0x457d,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 fb 38 00 00       	call   4185 <printf>
    exit();
     88a:	e8 36 37 00 00       	call   3fc5 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
     896:	e8 9a 37 00 00       	call   4035 <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 a8 64 00 00       	mov    0x64a8,%eax
     8a4:	c7 44 24 04 5f 49 00 	movl   $0x495f,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 d1 38 00 00       	call   4185 <printf>
    exit();
     8b4:	e8 0c 37 00 00       	call   3fc5 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 72 49 00 00 	movl   $0x4972,(%esp)
     8c0:	e8 70 37 00 00       	call   4035 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 a8 64 00 00       	mov    0x64a8,%eax
     8ce:	c7 44 24 04 75 49 00 	movl   $0x4975,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 a7 38 00 00       	call   4185 <printf>
    exit();
     8de:	e8 e2 36 00 00       	call   3fc5 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 5a 49 00 00 	movl   $0x495a,(%esp)
     8ea:	e8 26 37 00 00       	call   4015 <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 a8 64 00 00       	mov    0x64a8,%eax
     8f8:	c7 44 24 04 86 49 00 	movl   $0x4986,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 7d 38 00 00       	call   4185 <printf>
    exit();
     908:	e8 b8 36 00 00       	call   3fc5 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 a8 64 00 00       	mov    0x64a8,%eax
     912:	c7 44 24 04 9a 49 00 	movl   $0x499a,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 63 38 00 00       	call   4185 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     92f:	c7 44 24 04 a9 49 00 	movl   $0x49a9,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 46 38 00 00       	call   4185 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 94 64 00 	movl   $0x6494,0x4(%esp)
     946:	00 
     947:	c7 04 24 54 45 00 00 	movl   $0x4554,(%esp)
     94e:	e8 aa 36 00 00       	call   3ffd <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 a8 64 00 00       	mov    0x64a8,%eax
     95c:	c7 44 24 04 b4 49 00 	movl   $0x49b4,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 19 38 00 00       	call   4185 <printf>
    exit();
     96c:	e8 54 36 00 00       	call   3fc5 <exit>
  }
}
     971:	c9                   	leave  
     972:	c3                   	ret    
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     97f:	e8 51 36 00 00       	call   3fd5 <pipe>
     984:	85 c0                	test   %eax,%eax
     986:	74 19                	je     9a1 <pipe1+0x2e>
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 c6 49 00 	movl   $0x49c6,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 e9 37 00 00       	call   4185 <printf>
    exit();
     99c:	e8 24 36 00 00       	call   3fc5 <exit>
  }
  pid = fork();
     9a1:	e8 17 36 00 00       	call   3fbd <fork>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     9c0:	e8 28 36 00 00       	call   3fed <close>
    for(n = 0; n < 5; n++){
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a0e:	e8 d2 35 00 00       	call   3fe5 <write>
     a13:	3d 09 04 00 00       	cmp    $0x409,%eax
     a18:	74 19                	je     a33 <pipe1+0xc0>
        printf(1, "pipe1 oops 1\n");
     a1a:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 57 37 00 00       	call   4185 <printf>
        exit();
     a2e:	e8 92 35 00 00       	call   3fc5 <exit>
  }
  pid = fork();
  seq = 0;
  if(pid == 0){
    ...
    exit();
     a3d:	e8 83 35 00 00       	call   3fc5 <exit>
  } else if(pid > 0){
    ...
    close(fds[1]);
     ...
     a52:	e8 96 35 00 00       	call   3fed <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 e3 49 00 	movl   $0x49e3,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 e1 36 00 00       	call   4185 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae4:	e8 f4 34 00 00       	call   3fdd <read>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 f1 49 00 	movl   $0x49f1,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 6b 36 00 00       	call   4185 <printf>
      exit();
     b1a:	e8 a6 34 00 00       	call   3fc5 <exit>
    }
    close(fds[0]);
     b1f:	8b 45 d8             	mov    -0x28(%ebp),%eax
     b22:	89 04 24             	mov    %eax,(%esp)
     b25:	e8 c3 34 00 00       	call   3fed <close>
    wait();
     b2a:	e8 9e 34 00 00       	call   3fcd <wait>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 17 4a 00 	movl   $0x4a17,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 42 36 00 00       	call   4185 <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 2c 36 00 00       	call   4185 <printf>
    exit();
     b59:	e8 67 34 00 00       	call   3fc5 <exit>
  }
  printf(1, "pipe1 ok\n");
}
     b5e:	c9                   	leave  
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 21 4a 00 	movl   $0x4a21,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 0b 36 00 00       	call   4185 <printf>
  pid1 = fork();
     b7a:	e8 3e 34 00 00       	call   3fbd <fork>
  ...
  pid2 = fork();
     b8a:	e8 2e 34 00 00       	call   3fbd <fork>
  ...
  pipe(pfds);
     ...
     ba0:	e8 30 34 00 00       	call   3fd5 <pipe>
  pid3 = fork();
     ba5:	e8 13 34 00 00       	call   3fbd <fork>
  ...
  close(pfds[1]);
     ...
     c05:	e8 e3 33 00 00       	call   3fed <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c20:	e8 b8 33 00 00       	call   3fdd <read>
     c25:	83 f8 01             	cmp    $0x1,%eax
     c28:	74 16                	je     c40 <preempt+0xe0>
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 41 4a 00 	movl   $0x4a41,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 47 35 00 00       	call   4185 <printf>
  ...
  close(pfds[0]);
     ...
     c46:	e8 a2 33 00 00       	call   3fed <close>
  printf(1, "kill... ");
     c4b:	c7 44 24 04 54 4a 00 	movl   $0x4a54,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 26 35 00 00       	call   4185 <printf>
  kill(pid1);
     c5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
     c62:	89 04 24             	mov    %eax,(%esp)
     c65:	e8 8b 33 00 00       	call   3ff5 <kill>
  kill(pid2);
     c6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     c6d:	89 04 24             	mov    %eax,(%esp)
     c70:	e8 80 33 00 00       	call   3ff5 <kill>
  kill(pid3);
     c75:	8b 45 ec             	mov    -0x14(%ebp),%eax
     c78:	89 04 24             	mov    %eax,(%esp)
     c7b:	e8 75 33 00 00       	call   3ff5 <kill>
  printf(1, "wait... ");
     c80:	c7 44 24 04 5d 4a 00 	movl   $0x4a5d,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 f1 34 00 00       	call   4185 <printf>
  wait();
     c94:	e8 34 33 00 00       	call   3fcd <wait>
  wait();
     c99:	e8 2f 33 00 00       	call   3fcd <wait>
  wait();
     c9e:	e8 2a 33 00 00       	call   3fcd <wait>
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 66 4a 00 	movl   $0x4a66,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 ce 34 00 00       	call   4185 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid){
     ...
     cf0:	74 20                	je     d12 <exitwait+0x59>
      if(wait() != pid){
     cf2:	e8 d6 32 00 00       	call   3fcd <wait>
     cf7:	3b 45 f0             	cmp    -0x10(%ebp),%eax
     cfa:	74 1b                	je     d17 <exitwait+0x5e>
        printf(1, "wait wrong pid\n");
     cfc:	c7 44 24 04 72 4a 00 	movl   $0x4a72,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 75 34 00 00       	call   4185 <printf>
        return;
     d10:	eb 23                	jmp    d35 <exitwait+0x7c>
      }
    } else {
      exit();
     d12:	e8 ae 32 00 00       	call   3fc5 <exit>
void
exitwait(void)
{
  int i, pid;
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 82 4a 00 	movl   $0x4a82,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 50 34 00 00       	call   4185 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 8f 4a 00 	movl   $0x4a8f,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 34 34 00 00       	call   4185 <printf>
  ppid = getpid();
     d51:	e8 ef 32 00 00       	call   4045 <getpid>
     d56:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if((pid = fork()) == 0){
     d59:	e8 5f 32 00 00       	call   3fbd <fork>
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 e3 36 00 00       	call   4471 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 8c 35 00 00       	call   4338 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dbf:	e8 ad 36 00 00       	call   4471 <malloc>
     dc4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(m1 == 0){
     dc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     dcb:	75 24                	jne    df1 <mem+0xba>
      printf(1, "couldn't allocate mem?!!\n");
     dcd:	c7 44 24 04 99 4a 00 	movl   $0x4a99,0x4(%esp)
     dd4:	00 
     dd5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ddc:	e8 a4 33 00 00       	call   4185 <printf>
      kill(ppid);
     de1:	8b 45 f0             	mov    -0x10(%ebp),%eax
     de4:	89 04 24             	mov    %eax,(%esp)
     de7:	e8 09 32 00 00       	call   3ff5 <kill>
      exit();
     dec:	e8 d4 31 00 00       	call   3fc5 <exit>
    }
    free(m1);
     df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     df4:	89 04 24             	mov    %eax,(%esp)
     df7:	e8 3c 35 00 00       	call   4338 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 b3 4a 00 	movl   $0x4ab3,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 75 33 00 00       	call   4185 <printf>
    exit();
     e10:	e8 b0 31 00 00       	call   3fc5 <exit>
  } else {
    wait();
     e15:	e8 b3 31 00 00       	call   3fcd <wait>
  }
}
     e1a:	c9                   	leave  
     e1b:	c3                   	ret    
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 bb 4a 00 	movl   $0x4abb,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 4f 33 00 00       	call   4185 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 ca 4a 00 00 	movl   $0x4aca,(%esp)
     e3d:	e8 d3 31 00 00       	call   4015 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 ca 4a 00 00 	movl   $0x4aca,(%esp)
     e51:	e8 af 31 00 00       	call   4005 <open>
     e56:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     e59:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     e5d:	79 19                	jns    e78 <sharedfd+0x5c>
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 d4 4a 00 	movl   $0x4ad4,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 12 33 00 00       	call   4185 <printf>
    return;
     e73:	e9 a0 01 00 00       	jmp    1018 <sharedfd+0x1fc>
  }
  pid = fork();
     e78:	e8 40 31 00 00       	call   3fbd <fork>
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     ea4:	e8 6f 2f 00 00       	call   3e18 <memset>
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ec7:	e8 19 31 00 00       	call   3fe5 <write>
     ecc:	83 f8 0a             	cmp    $0xa,%eax
     ecf:	74 16                	je     ee7 <sharedfd+0xcb>
      printf(1, "fstests: write sharedfd failed\n");
     ed1:	c7 44 24 04 00 4b 00 	movl   $0x4b00,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 a0 32 00 00       	call   4185 <printf>
      break;
  ...
  if(pid == 0)
    ...
    exit();
     efa:	e8 c6 30 00 00       	call   3fc5 <exit>
  else
    wait();
     eff:	e8 c9 30 00 00       	call   3fcd <wait>
  close(fd);
     f04:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f07:	89 04 24             	mov    %eax,(%esp)
     f0a:	e8 de 30 00 00       	call   3fed <close>
  fd = open("sharedfd", 0);
     f0f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     f16:	00 
     f17:	c7 04 24 ca 4a 00 00 	movl   $0x4aca,(%esp)
     f1e:	e8 e2 30 00 00       	call   4005 <open>
     f23:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     f26:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     f2a:	79 19                	jns    f45 <sharedfd+0x129>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 20 4b 00 	movl   $0x4b20,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 45 32 00 00       	call   4185 <printf>
    return;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fa4:	e8 34 30 00 00       	call   3fdd <read>
  ...
  close(fd);
     ...
     fb8:	e8 30 30 00 00       	call   3fed <close>
  unlink("sharedfd");
     fbd:	c7 04 24 ca 4a 00 00 	movl   $0x4aca,(%esp)
     fc4:	e8 4c 30 00 00       	call   4015 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 4b 4b 00 	movl   $0x4b4b,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 96 31 00 00       	call   4185 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 58 4b 00 	movl   $0x4b58,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 72 31 00 00       	call   4185 <printf>
    exit();
    1013:	e8 ad 2f 00 00       	call   3fc5 <exit>
  }
}
    1018:	c9                   	leave  
    1019:	c3                   	ret    
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 6d 4b 00 00 	movl   $0x4b6d,-0x38(%ebp)
    1027:	c7 45 cc 70 4b 00 00 	movl   $0x4b70,-0x34(%ebp)
    102e:	c7 45 d0 73 4b 00 00 	movl   $0x4b73,-0x30(%ebp)
    1035:	c7 45 d4 76 4b 00 00 	movl   $0x4b76,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 35 31 00 00       	call   4185 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106c:	e8 a4 2f 00 00       	call   4015 <unlink>

    pid = fork();
    1071:	e8 47 2f 00 00       	call   3fbd <fork>
    1076:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if(pid < 0){
    1079:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 f2 30 00 00       	call   4185 <printf>
      exit();
    1093:	e8 2d 2f 00 00       	call   3fc5 <exit>
    }
    ...
    10b0:	e8 50 2f 00 00       	call   4005 <open>
    10b5:	89 45 dc             	mov    %eax,-0x24(%ebp)
      if(fd < 0){
    10b8:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
    10bc:	79 19                	jns    10d7 <fourfiles+0xbd>
        printf(1, "create failed\n");
    10be:	c7 44 24 04 89 4b 00 	movl   $0x4b89,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 b3 30 00 00       	call   4185 <printf>
        exit();
    10d2:	e8 ee 2e 00 00       	call   3fc5 <exit>
      }
    ...
    10f0:	e8 23 2d 00 00       	call   3e18 <memset>
      for(i = 0; i < 12; i++){
    ...
    1114:	e8 cc 2e 00 00       	call   3fe5 <write>
    ...
    112c:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 45 30 00 00       	call   4185 <printf>
          exit();
    1140:	e8 80 2e 00 00       	call   3fc5 <exit>
        printf(1, "create failed\n");
        exit();
      }
    ...
    114d:	7e af                	jle    10fe <fourfiles+0xe4>
      ...
      exit();
    114f:	e8 71 2e 00 00       	call   3fc5 <exit>
  char *names[] = { "f0", "f1", "f2", "f3" };
  char *fname;
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    116b:	e8 5d 2e 00 00       	call   3fcd <wait>
      }
      exit();
    }
  }
  ...
  for(i = 0; i < 2; i++){
    ...
    119e:	e8 62 2e 00 00       	call   4005 <open>
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 a9 4b 00 	movl   $0x4ba9,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 a1 2f 00 00       	call   4185 <printf>
          exit();
    11e4:	e8 dc 2d 00 00       	call   3fc5 <exit>
  for(i = 0; i < 2; i++){
    fname = names[i];
    fd = open(fname, 0);
    total = 0;
  ...
  for(i = 0; i < 2; i++){
    ...
    1211:	e8 c7 2d 00 00       	call   3fdd <read>
    ...
    1225:	e8 c3 2d 00 00       	call   3fed <close>
    if(total != 12*500){
    ...
    123a:	c7 44 24 04 b5 4b 00 	movl   $0x4bb5,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 37 2f 00 00       	call   4185 <printf>
      exit();
    124e:	e8 72 2d 00 00       	call   3fc5 <exit>
    }
    unlink(fname);
    1253:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1256:	89 04 24             	mov    %eax,(%esp)
    1259:	e8 b7 2d 00 00       	call   4015 <unlink>
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 c6 4b 00 	movl   $0x4bc6,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 05 2f 00 00       	call   4185 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1363:	e8 ad 2c 00 00       	call   4015 <unlink>
    1368:	85 c0                	test   %eax,%eax
    136a:	79 19                	jns    1385 <createdelete+0x103>
            printf(1, "unlink failed\n");
    136c:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 05 2e 00 00       	call   4185 <printf>
            exit();
    1380:	e8 40 2c 00 00       	call   3fc5 <exit>
    }
    ...
    138d:	0f 8e 5f ff ff ff    	jle    12f2 <createdelete+0x70>
      ...
      exit();
    1393:	e8 2d 2c 00 00       	call   3fc5 <exit>
  int pid, i, fd, pi;
  char name[32];
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    13af:	e8 19 2c 00 00       	call   3fcd <wait>
      }
      exit();
    }
  }
  ...
  for(i = 0; i < N; i++){
    ...
    1408:	e8 f8 2b 00 00       	call   4005 <open>
    ...
    1429:	c7 44 24 04 e8 4b 00 	movl   $0x4be8,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 48 2d 00 00       	call   4185 <printf>
        exit();
    143d:	e8 83 2b 00 00       	call   3fc5 <exit>
    ...
    145b:	c7 44 24 04 0c 4c 00 	movl   $0x4c0c,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 16 2d 00 00       	call   4185 <printf>
        exit();
    146f:	e8 51 2b 00 00       	call   3fc5 <exit>
      }
      if(fd >= 0)
    ...
    1480:	e8 68 2b 00 00       	call   3fed <close>
    wait();
  }
  ...
  for(i = 0; i < N; i++){
    ...
    14cb:	e8 45 2b 00 00       	call   4015 <unlink>
        close(fd);
    }
  }
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 2c 4c 00 	movl   $0x4c2c,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 8d 2c 00 00       	call   4185 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 3d 4c 00 	movl   $0x4c3d,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 71 2c 00 00       	call   4185 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 4e 4c 00 00 	movl   $0x4c4e,(%esp)
    1523:	e8 dd 2a 00 00       	call   4005 <open>
    1528:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    152b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    152f:	79 19                	jns    154a <unlinkread+0x50>
    printf(1, "create unlinkread failed\n");
    1531:	c7 44 24 04 59 4c 00 	movl   $0x4c59,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 40 2c 00 00       	call   4185 <printf>
    exit();
    1545:	e8 7b 2a 00 00       	call   3fc5 <exit>
  }
  write(fd, "hello", 5);
    154a:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    1551:	00 
    1552:	c7 44 24 04 73 4c 00 	movl   $0x4c73,0x4(%esp)
    1559:	00 
    155a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    155d:	89 04 24             	mov    %eax,(%esp)
    1560:	e8 80 2a 00 00       	call   3fe5 <write>
  close(fd);
    1565:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1568:	89 04 24             	mov    %eax,(%esp)
    156b:	e8 7d 2a 00 00       	call   3fed <close>

  fd = open("unlinkread", O_RDWR);
    1570:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    1577:	00 
    1578:	c7 04 24 4e 4c 00 00 	movl   $0x4c4e,(%esp)
    157f:	e8 81 2a 00 00       	call   4005 <open>
    1584:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1587:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    158b:	79 19                	jns    15a6 <unlinkread+0xac>
    printf(1, "open unlinkread failed\n");
    158d:	c7 44 24 04 79 4c 00 	movl   $0x4c79,0x4(%esp)
    1594:	00 
    1595:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    159c:	e8 e4 2b 00 00       	call   4185 <printf>
    exit();
    15a1:	e8 1f 2a 00 00       	call   3fc5 <exit>
  }
  if(unlink("unlinkread") != 0){
    15a6:	c7 04 24 4e 4c 00 00 	movl   $0x4c4e,(%esp)
    15ad:	e8 63 2a 00 00       	call   4015 <unlink>
    15b2:	85 c0                	test   %eax,%eax
    15b4:	74 19                	je     15cf <unlinkread+0xd5>
    printf(1, "unlink unlinkread failed\n");
    15b6:	c7 44 24 04 91 4c 00 	movl   $0x4c91,0x4(%esp)
    15bd:	00 
    15be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c5:	e8 bb 2b 00 00       	call   4185 <printf>
    exit();
    15ca:	e8 f6 29 00 00       	call   3fc5 <exit>
  }

  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    15cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    15d6:	00 
    15d7:	c7 04 24 4e 4c 00 00 	movl   $0x4c4e,(%esp)
    15de:	e8 22 2a 00 00       	call   4005 <open>
    15e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  write(fd1, "yyy", 3);
    15e6:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15ed:	00 
    15ee:	c7 44 24 04 ab 4c 00 	movl   $0x4cab,0x4(%esp)
    15f5:	00 
    15f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    15f9:	89 04 24             	mov    %eax,(%esp)
    15fc:	e8 e4 29 00 00       	call   3fe5 <write>
  close(fd1);
    1601:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1604:	89 04 24             	mov    %eax,(%esp)
    1607:	e8 e1 29 00 00       	call   3fed <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1622:	e8 b6 29 00 00       	call   3fdd <read>
    1627:	83 f8 05             	cmp    $0x5,%eax
    162a:	74 19                	je     1645 <unlinkread+0x14b>
    printf(1, "unlinkread read failed");
    162c:	c7 44 24 04 af 4c 00 	movl   $0x4caf,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 45 2b 00 00       	call   4185 <printf>
    exit();
    1640:	e8 80 29 00 00       	call   3fc5 <exit>
  }
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 c6 4c 00 	movl   $0x4cc6,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 21 2b 00 00       	call   4185 <printf>
    exit();
    1664:	e8 5c 29 00 00       	call   3fc5 <exit>
  }
  if(write(fd, buf, 10) != 10){
    ...
    167f:	e8 61 29 00 00       	call   3fe5 <write>
    1684:	83 f8 0a             	cmp    $0xa,%eax
    1687:	74 19                	je     16a2 <unlinkread+0x1a8>
    printf(1, "unlinkread write failed\n");
    1689:	c7 44 24 04 dd 4c 00 	movl   $0x4cdd,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 e8 2a 00 00       	call   4185 <printf>
    exit();
    169d:	e8 23 29 00 00       	call   3fc5 <exit>
  }
  close(fd);
    16a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16a5:	89 04 24             	mov    %eax,(%esp)
    16a8:	e8 40 29 00 00       	call   3fed <close>
  unlink("unlinkread");
    16ad:	c7 04 24 4e 4c 00 00 	movl   $0x4c4e,(%esp)
    16b4:	e8 5c 29 00 00       	call   4015 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 f6 4c 00 	movl   $0x4cf6,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 b8 2a 00 00       	call   4185 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 05 4d 00 	movl   $0x4d05,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 9c 2a 00 00       	call   4185 <printf>

  unlink("lf1");
    16e9:	c7 04 24 0f 4d 00 00 	movl   $0x4d0f,(%esp)
    16f0:	e8 20 29 00 00       	call   4015 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 13 4d 00 00 	movl   $0x4d13,(%esp)
    16fc:	e8 14 29 00 00       	call   4015 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 0f 4d 00 00 	movl   $0x4d0f,(%esp)
    1710:	e8 f0 28 00 00       	call   4005 <open>
    1715:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1718:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    171c:	79 19                	jns    1737 <linktest+0x68>
    printf(1, "create lf1 failed\n");
    171e:	c7 44 24 04 17 4d 00 	movl   $0x4d17,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 53 2a 00 00       	call   4185 <printf>
    exit();
    1732:	e8 8e 28 00 00       	call   3fc5 <exit>
  }
  if(write(fd, "hello", 5) != 5){
    1737:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    173e:	00 
    173f:	c7 44 24 04 73 4c 00 	movl   $0x4c73,0x4(%esp)
    1746:	00 
    1747:	8b 45 f4             	mov    -0xc(%ebp),%eax
    174a:	89 04 24             	mov    %eax,(%esp)
    174d:	e8 93 28 00 00       	call   3fe5 <write>
    1752:	83 f8 05             	cmp    $0x5,%eax
    1755:	74 19                	je     1770 <linktest+0xa1>
    printf(1, "write lf1 failed\n");
    1757:	c7 44 24 04 2a 4d 00 	movl   $0x4d2a,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 1a 2a 00 00       	call   4185 <printf>
    exit();
    176b:	e8 55 28 00 00       	call   3fc5 <exit>
  }
  close(fd);
    1770:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1773:	89 04 24             	mov    %eax,(%esp)
    1776:	e8 72 28 00 00       	call   3fed <close>

  if(link("lf1", "lf2") < 0){
    177b:	c7 44 24 04 13 4d 00 	movl   $0x4d13,0x4(%esp)
    1782:	00 
    1783:	c7 04 24 0f 4d 00 00 	movl   $0x4d0f,(%esp)
    178a:	e8 96 28 00 00       	call   4025 <link>
    178f:	85 c0                	test   %eax,%eax
    1791:	79 19                	jns    17ac <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1793:	c7 44 24 04 3c 4d 00 	movl   $0x4d3c,0x4(%esp)
    179a:	00 
    179b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17a2:	e8 de 29 00 00       	call   4185 <printf>
    exit();
    17a7:	e8 19 28 00 00       	call   3fc5 <exit>
  }
  unlink("lf1");
    17ac:	c7 04 24 0f 4d 00 00 	movl   $0x4d0f,(%esp)
    17b3:	e8 5d 28 00 00       	call   4015 <unlink>

  if(open("lf1", 0) >= 0){
    17b8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17bf:	00 
    17c0:	c7 04 24 0f 4d 00 00 	movl   $0x4d0f,(%esp)
    17c7:	e8 39 28 00 00       	call   4005 <open>
    17cc:	85 c0                	test   %eax,%eax
    17ce:	78 19                	js     17e9 <linktest+0x11a>
    printf(1, "unlinked lf1 but it is still there!\n");
    17d0:	c7 44 24 04 54 4d 00 	movl   $0x4d54,0x4(%esp)
    17d7:	00 
    17d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17df:	e8 a1 29 00 00       	call   4185 <printf>
    exit();
    17e4:	e8 dc 27 00 00       	call   3fc5 <exit>
  }

  fd = open("lf2", 0);
    17e9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17f0:	00 
    17f1:	c7 04 24 13 4d 00 00 	movl   $0x4d13,(%esp)
    17f8:	e8 08 28 00 00       	call   4005 <open>
    17fd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1800:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1804:	79 19                	jns    181f <linktest+0x150>
    printf(1, "open lf2 failed\n");
    1806:	c7 44 24 04 79 4d 00 	movl   $0x4d79,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 6b 29 00 00       	call   4185 <printf>
    exit();
    181a:	e8 a6 27 00 00       	call   3fc5 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1835:	e8 a3 27 00 00       	call   3fdd <read>
    183a:	83 f8 05             	cmp    $0x5,%eax
    183d:	74 19                	je     1858 <linktest+0x189>
    printf(1, "read lf2 failed\n");
    183f:	c7 44 24 04 8a 4d 00 	movl   $0x4d8a,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 32 29 00 00       	call   4185 <printf>
    exit();
    1853:	e8 6d 27 00 00       	call   3fc5 <exit>
  }
  close(fd);
    1858:	8b 45 f4             	mov    -0xc(%ebp),%eax
    185b:	89 04 24             	mov    %eax,(%esp)
    185e:	e8 8a 27 00 00       	call   3fed <close>

  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 13 4d 00 	movl   $0x4d13,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 13 4d 00 00 	movl   $0x4d13,(%esp)
    1872:	e8 ae 27 00 00       	call   4025 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 9b 4d 00 	movl   $0x4d9b,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 f6 28 00 00       	call   4185 <printf>
    exit();
    188f:	e8 31 27 00 00       	call   3fc5 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 13 4d 00 00 	movl   $0x4d13,(%esp)
    189b:	e8 75 27 00 00       	call   4015 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 0f 4d 00 	movl   $0x4d0f,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 13 4d 00 00 	movl   $0x4d13,(%esp)
    18af:	e8 71 27 00 00       	call   4025 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 bc 4d 00 	movl   $0x4dbc,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 b9 28 00 00       	call   4185 <printf>
    exit();
    18cc:	e8 f4 26 00 00       	call   3fc5 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 0f 4d 00 	movl   $0x4d0f,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 df 4d 00 00 	movl   $0x4ddf,(%esp)
    18e0:	e8 40 27 00 00       	call   4025 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 e1 4d 00 	movl   $0x4de1,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 88 28 00 00       	call   4185 <printf>
    exit();
    18fd:	e8 c3 26 00 00       	call   3fc5 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 fd 4d 00 	movl   $0x4dfd,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 6f 28 00 00       	call   4185 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 0a 4e 00 	movl   $0x4e0a,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 53 28 00 00       	call   4185 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1955:	e8 bb 26 00 00       	call   4015 <unlink>
    pid = fork();
    195a:	e8 5e 26 00 00       	call   3fbd <fork>
    ...
    1991:	c7 04 24 1a 4e 00 00 	movl   $0x4e1a,(%esp)
    1998:	e8 88 26 00 00       	call   4025 <link>
    ...
    19d4:	c7 04 24 1a 4e 00 00 	movl   $0x4e1a,(%esp)
    19db:	e8 45 26 00 00       	call   4025 <link>
    ...
    19f0:	e8 10 26 00 00       	call   4005 <open>
    ...
    1a05:	c7 44 24 04 1d 4e 00 	movl   $0x4e1d,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 6c 27 00 00       	call   4185 <printf>
        exit();
    1a19:	e8 a7 25 00 00       	call   3fc5 <exit>
      }
      close(fd);
    1a1e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1a21:	89 04 24             	mov    %eax,(%esp)
    1a24:	e8 c4 25 00 00       	call   3fed <close>
    }
    if(pid == 0)
    1a29:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1a2d:	75 05                	jne    1a34 <concreate+0x11c>
      exit();
    1a2f:	e8 91 25 00 00       	call   3fc5 <exit>
    else
      wait();
    1a34:	e8 94 25 00 00       	call   3fcd <wait>
  } de;
  ...
  memset(fa, 0, sizeof(fa));
    ...
    1a5d:	e8 b6 23 00 00       	call   3e18 <memset>
  fd = open(".", 0);
    1a62:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1a69:	00 
    1a6a:	c7 04 24 df 4d 00 00 	movl   $0x4ddf,(%esp)
    1a71:	e8 8f 25 00 00       	call   4005 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 39 4e 00 	movl   $0x4e39,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 a5 26 00 00       	call   4185 <printf>
        exit();
    1ae0:	e8 e0 24 00 00       	call   3fc5 <exit>
      }
      if(fa[i]){
    ...
    1afe:	c7 44 24 04 52 4e 00 	movl   $0x4e52,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 73 26 00 00       	call   4185 <printf>
        exit();
    1b12:	e8 ae 24 00 00       	call   3fc5 <exit>
      }
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1b3b:	e8 9d 24 00 00       	call   3fdd <read>
  ...
  close(fd);
    ...
    1b4e:	e8 9a 24 00 00       	call   3fed <close>

  if(n != 40){
    1b53:	83 7d f0 28          	cmpl   $0x28,-0x10(%ebp)
    1b57:	74 19                	je     1b72 <concreate+0x25a>
    printf(1, "concreate not enough files in directory listing\n");
    1b59:	c7 44 24 04 70 4e 00 	movl   $0x4e70,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 18 26 00 00       	call   4185 <printf>
    exit();
    1b6d:	e8 53 24 00 00       	call   3fc5 <exit>
  }
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1b87:	e8 31 24 00 00       	call   3fbd <fork>
    1b8c:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(pid < 0){
    1b8f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 dc 25 00 00       	call   4185 <printf>
      exit();
    1ba9:	e8 17 24 00 00       	call   3fc5 <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 a1 4e 00 	movl   $0x4ea1,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 bc 24 00 00       	call   4185 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 af 4e 00 	movl   $0x4eaf,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 a0 24 00 00       	call   4185 <printf>

  unlink("x");
    1ce5:	c7 04 24 2b 4a 00 00 	movl   $0x4a2b,(%esp)
    1cec:	e8 24 23 00 00       	call   4015 <unlink>
  pid = fork();
    1cf1:	e8 c7 22 00 00       	call   3fbd <fork>
    1cf6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(pid < 0){
    1cf9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1cfd:	79 19                	jns    1d18 <linkunlink+0x4d>
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 72 24 00 00       	call   4185 <printf>
    exit();
    1d13:	e8 ad 22 00 00       	call   3fc5 <exit>
  }
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 2b 4a 00 00 	movl   $0x4a2b,(%esp)
    1d75:	e8 8b 22 00 00       	call   4005 <open>
    1d7a:	89 04 24             	mov    %eax,(%esp)
    1d7d:	e8 6b 22 00 00       	call   3fed <close>
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 2b 4a 00 	movl   $0x4a2b,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 c0 4e 00 00 	movl   $0x4ec0,(%esp)
    1db0:	e8 70 22 00 00       	call   4025 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 2b 4a 00 00 	movl   $0x4a2b,(%esp)
    1dbe:	e8 52 22 00 00       	call   4015 <unlink>
    printf(1, "fork failed\n");
    exit();
  }
  ...
  if(pid)
    ...
    wait();
    1dd7:	e8 f1 21 00 00       	call   3fcd <wait>
    1ddc:	eb 05                	jmp    1de3 <linkunlink+0x118>
  else 
    exit();
    1dde:	e8 e2 21 00 00       	call   3fc5 <exit>

  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 c4 4e 00 	movl   $0x4ec4,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 8e 23 00 00       	call   4185 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 d3 4e 00 	movl   $0x4ed3,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 72 23 00 00       	call   4185 <printf>
  unlink("bd");
    1e13:	c7 04 24 e0 4e 00 00 	movl   $0x4ee0,(%esp)
    1e1a:	e8 f6 21 00 00       	call   4015 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 e0 4e 00 00 	movl   $0x4ee0,(%esp)
    1e2e:	e8 d2 21 00 00       	call   4005 <open>
    1e33:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd < 0){
    1e36:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e3a:	79 19                	jns    1e55 <bigdir+0x5c>
    printf(1, "bigdir create failed\n");
    1e3c:	c7 44 24 04 e3 4e 00 	movl   $0x4ee3,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 35 23 00 00       	call   4185 <printf>
    exit();
    1e50:	e8 70 21 00 00       	call   3fc5 <exit>
  }
  close(fd);
    1e55:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e58:	89 04 24             	mov    %eax,(%esp)
    1e5b:	e8 8d 21 00 00       	call   3fed <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ea0:	c7 04 24 e0 4e 00 00 	movl   $0x4ee0,(%esp)
    1ea7:	e8 79 21 00 00       	call   4025 <link>
    1eac:	85 c0                	test   %eax,%eax
    1eae:	74 19                	je     1ec9 <bigdir+0xd0>
      printf(1, "bigdir link failed\n");
    1eb0:	c7 44 24 04 f9 4e 00 	movl   $0x4ef9,0x4(%esp)
    1eb7:	00 
    1eb8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ebf:	e8 c1 22 00 00       	call   4185 <printf>
      exit();
    1ec4:	e8 fc 20 00 00       	call   3fc5 <exit>
    printf(1, "bigdir create failed\n");
    exit();
  }
  close(fd);
  ...
  unlink("bd");
    1ed6:	c7 04 24 e0 4e 00 00 	movl   $0x4ee0,(%esp)
    1edd:	e8 33 21 00 00       	call   4015 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1f21:	e8 ef 20 00 00       	call   4015 <unlink>
    1f26:	85 c0                	test   %eax,%eax
    1f28:	74 19                	je     1f43 <bigdir+0x14a>
      printf(1, "bigdir unlink failed");
    1f2a:	c7 44 24 04 0d 4f 00 	movl   $0x4f0d,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 47 22 00 00       	call   4185 <printf>
      exit();
    1f3e:	e8 82 20 00 00       	call   3fc5 <exit>
      exit();
    }
  }
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 22 4f 00 	movl   $0x4f22,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 21 22 00 00       	call   4185 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 2d 4f 00 	movl   $0x4f2d,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 05 22 00 00       	call   4185 <printf>

  unlink("ff");
    1f80:	c7 04 24 3a 4f 00 00 	movl   $0x4f3a,(%esp)
    1f87:	e8 89 20 00 00       	call   4015 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    1f93:	e8 95 20 00 00       	call   402d <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 40 4f 00 	movl   $0x4f40,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 d5 21 00 00       	call   4185 <printf>
    exit();
    1fb0:	e8 10 20 00 00       	call   3fc5 <exit>
  }

  fd = open("dd/ff", O_CREATE | O_RDWR);
    1fb5:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1fbc:	00 
    1fbd:	c7 04 24 58 4f 00 00 	movl   $0x4f58,(%esp)
    1fc4:	e8 3c 20 00 00       	call   4005 <open>
    1fc9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1fcc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fd0:	79 19                	jns    1feb <subdir+0x85>
    printf(1, "create dd/ff failed\n");
    1fd2:	c7 44 24 04 5e 4f 00 	movl   $0x4f5e,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 9f 21 00 00       	call   4185 <printf>
    exit();
    1fe6:	e8 da 1f 00 00       	call   3fc5 <exit>
  }
  write(fd, "ff", 2);
    1feb:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    1ff2:	00 
    1ff3:	c7 44 24 04 3a 4f 00 	movl   $0x4f3a,0x4(%esp)
    1ffa:	00 
    1ffb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1ffe:	89 04 24             	mov    %eax,(%esp)
    2001:	e8 df 1f 00 00       	call   3fe5 <write>
  close(fd);
    2006:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2009:	89 04 24             	mov    %eax,(%esp)
    200c:	e8 dc 1f 00 00       	call   3fed <close>
  
  if(unlink("dd") >= 0){
    2011:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    2018:	e8 f8 1f 00 00       	call   4015 <unlink>
    201d:	85 c0                	test   %eax,%eax
    201f:	78 19                	js     203a <subdir+0xd4>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2021:	c7 44 24 04 74 4f 00 	movl   $0x4f74,0x4(%esp)
    2028:	00 
    2029:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2030:	e8 50 21 00 00       	call   4185 <printf>
    exit();
    2035:	e8 8b 1f 00 00       	call   3fc5 <exit>
  }

  if(mkdir("/dd/dd") != 0){
    203a:	c7 04 24 9a 4f 00 00 	movl   $0x4f9a,(%esp)
    2041:	e8 e7 1f 00 00       	call   402d <mkdir>
    2046:	85 c0                	test   %eax,%eax
    2048:	74 19                	je     2063 <subdir+0xfd>
    printf(1, "subdir mkdir dd/dd failed\n");
    204a:	c7 44 24 04 a1 4f 00 	movl   $0x4fa1,0x4(%esp)
    2051:	00 
    2052:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2059:	e8 27 21 00 00       	call   4185 <printf>
    exit();
    205e:	e8 62 1f 00 00       	call   3fc5 <exit>
  }

  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2063:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    206a:	00 
    206b:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    2072:	e8 8e 1f 00 00       	call   4005 <open>
    2077:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    207a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    207e:	79 19                	jns    2099 <subdir+0x133>
    printf(1, "create dd/dd/ff failed\n");
    2080:	c7 44 24 04 c5 4f 00 	movl   $0x4fc5,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 f1 20 00 00       	call   4185 <printf>
    exit();
    2094:	e8 2c 1f 00 00       	call   3fc5 <exit>
  }
  write(fd, "FF", 2);
    2099:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    20a0:	00 
    20a1:	c7 44 24 04 dd 4f 00 	movl   $0x4fdd,0x4(%esp)
    20a8:	00 
    20a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20ac:	89 04 24             	mov    %eax,(%esp)
    20af:	e8 31 1f 00 00       	call   3fe5 <write>
  close(fd);
    20b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20b7:	89 04 24             	mov    %eax,(%esp)
    20ba:	e8 2e 1f 00 00       	call   3fed <close>

  fd = open("dd/dd/../ff", 0);
    20bf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    20c6:	00 
    20c7:	c7 04 24 e0 4f 00 00 	movl   $0x4fe0,(%esp)
    20ce:	e8 32 1f 00 00       	call   4005 <open>
    20d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    20d6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20da:	79 19                	jns    20f5 <subdir+0x18f>
    printf(1, "open dd/dd/../ff failed\n");
    20dc:	c7 44 24 04 ec 4f 00 	movl   $0x4fec,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 95 20 00 00       	call   4185 <printf>
    exit();
    20f0:	e8 d0 1e 00 00       	call   3fc5 <exit>
  }
  cc = read(fd, buf, sizeof(buf));
    ...
    210b:	e8 cd 1e 00 00       	call   3fdd <read>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 05 50 00 	movl   $0x5005,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 4d 20 00 00       	call   4185 <printf>
    exit();
    2138:	e8 88 1e 00 00       	call   3fc5 <exit>
  }
  close(fd);
    213d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2140:	89 04 24             	mov    %eax,(%esp)
    2143:	e8 a5 1e 00 00       	call   3fed <close>

  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2148:	c7 44 24 04 20 50 00 	movl   $0x5020,0x4(%esp)
    214f:	00 
    2150:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    2157:	e8 c9 1e 00 00       	call   4025 <link>
    215c:	85 c0                	test   %eax,%eax
    215e:	74 19                	je     2179 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2160:	c7 44 24 04 2c 50 00 	movl   $0x502c,0x4(%esp)
    2167:	00 
    2168:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    216f:	e8 11 20 00 00       	call   4185 <printf>
    exit();
    2174:	e8 4c 1e 00 00       	call   3fc5 <exit>
  }

  if(unlink("dd/dd/ff") != 0){
    2179:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    2180:	e8 90 1e 00 00       	call   4015 <unlink>
    2185:	85 c0                	test   %eax,%eax
    2187:	74 19                	je     21a2 <subdir+0x23c>
    printf(1, "unlink dd/dd/ff failed\n");
    2189:	c7 44 24 04 4d 50 00 	movl   $0x504d,0x4(%esp)
    2190:	00 
    2191:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2198:	e8 e8 1f 00 00       	call   4185 <printf>
    exit();
    219d:	e8 23 1e 00 00       	call   3fc5 <exit>
  }
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    21a2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    21a9:	00 
    21aa:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    21b1:	e8 4f 1e 00 00       	call   4005 <open>
    21b6:	85 c0                	test   %eax,%eax
    21b8:	78 19                	js     21d3 <subdir+0x26d>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    21ba:	c7 44 24 04 68 50 00 	movl   $0x5068,0x4(%esp)
    21c1:	00 
    21c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21c9:	e8 b7 1f 00 00       	call   4185 <printf>
    exit();
    21ce:	e8 f2 1d 00 00       	call   3fc5 <exit>
  }

  if(chdir("dd") != 0){
    21d3:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    21da:	e8 56 1e 00 00       	call   4035 <chdir>
    21df:	85 c0                	test   %eax,%eax
    21e1:	74 19                	je     21fc <subdir+0x296>
    printf(1, "chdir dd failed\n");
    21e3:	c7 44 24 04 8c 50 00 	movl   $0x508c,0x4(%esp)
    21ea:	00 
    21eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21f2:	e8 8e 1f 00 00       	call   4185 <printf>
    exit();
    21f7:	e8 c9 1d 00 00       	call   3fc5 <exit>
  }
  if(chdir("dd/../../dd") != 0){
    21fc:	c7 04 24 9d 50 00 00 	movl   $0x509d,(%esp)
    2203:	e8 2d 1e 00 00       	call   4035 <chdir>
    2208:	85 c0                	test   %eax,%eax
    220a:	74 19                	je     2225 <subdir+0x2bf>
    printf(1, "chdir dd/../../dd failed\n");
    220c:	c7 44 24 04 a9 50 00 	movl   $0x50a9,0x4(%esp)
    2213:	00 
    2214:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    221b:	e8 65 1f 00 00       	call   4185 <printf>
    exit();
    2220:	e8 a0 1d 00 00       	call   3fc5 <exit>
  }
  if(chdir("dd/../../../dd") != 0){
    2225:	c7 04 24 c3 50 00 00 	movl   $0x50c3,(%esp)
    222c:	e8 04 1e 00 00       	call   4035 <chdir>
    2231:	85 c0                	test   %eax,%eax
    2233:	74 19                	je     224e <subdir+0x2e8>
    printf(1, "chdir dd/../../dd failed\n");
    2235:	c7 44 24 04 a9 50 00 	movl   $0x50a9,0x4(%esp)
    223c:	00 
    223d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2244:	e8 3c 1f 00 00       	call   4185 <printf>
    exit();
    2249:	e8 77 1d 00 00       	call   3fc5 <exit>
  }
  if(chdir("./..") != 0){
    224e:	c7 04 24 d2 50 00 00 	movl   $0x50d2,(%esp)
    2255:	e8 db 1d 00 00       	call   4035 <chdir>
    225a:	85 c0                	test   %eax,%eax
    225c:	74 19                	je     2277 <subdir+0x311>
    printf(1, "chdir ./.. failed\n");
    225e:	c7 44 24 04 d7 50 00 	movl   $0x50d7,0x4(%esp)
    2265:	00 
    2266:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    226d:	e8 13 1f 00 00       	call   4185 <printf>
    exit();
    2272:	e8 4e 1d 00 00       	call   3fc5 <exit>
  }

  fd = open("dd/dd/ffff", 0);
    2277:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    227e:	00 
    227f:	c7 04 24 20 50 00 00 	movl   $0x5020,(%esp)
    2286:	e8 7a 1d 00 00       	call   4005 <open>
    228b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    228e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2292:	79 19                	jns    22ad <subdir+0x347>
    printf(1, "open dd/dd/ffff failed\n");
    2294:	c7 44 24 04 ea 50 00 	movl   $0x50ea,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 dd 1e 00 00       	call   4185 <printf>
    exit();
    22a8:	e8 18 1d 00 00       	call   3fc5 <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22c3:	e8 15 1d 00 00       	call   3fdd <read>
    22c8:	83 f8 02             	cmp    $0x2,%eax
    22cb:	74 19                	je     22e6 <subdir+0x380>
    printf(1, "read dd/dd/ffff wrong len\n");
    22cd:	c7 44 24 04 02 51 00 	movl   $0x5102,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 a4 1e 00 00       	call   4185 <printf>
    exit();
    22e1:	e8 df 1c 00 00       	call   3fc5 <exit>
  }
  close(fd);
    22e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22e9:	89 04 24             	mov    %eax,(%esp)
    22ec:	e8 fc 1c 00 00       	call   3fed <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    22f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    22f8:	00 
    22f9:	c7 04 24 bc 4f 00 00 	movl   $0x4fbc,(%esp)
    2300:	e8 00 1d 00 00       	call   4005 <open>
    2305:	85 c0                	test   %eax,%eax
    2307:	78 19                	js     2322 <subdir+0x3bc>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2309:	c7 44 24 04 20 51 00 	movl   $0x5120,0x4(%esp)
    2310:	00 
    2311:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2318:	e8 68 1e 00 00       	call   4185 <printf>
    exit();
    231d:	e8 a3 1c 00 00       	call   3fc5 <exit>
  }

  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2322:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2329:	00 
    232a:	c7 04 24 45 51 00 00 	movl   $0x5145,(%esp)
    2331:	e8 cf 1c 00 00       	call   4005 <open>
    2336:	85 c0                	test   %eax,%eax
    2338:	78 19                	js     2353 <subdir+0x3ed>
    printf(1, "create dd/ff/ff succeeded!\n");
    233a:	c7 44 24 04 4e 51 00 	movl   $0x514e,0x4(%esp)
    2341:	00 
    2342:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2349:	e8 37 1e 00 00       	call   4185 <printf>
    exit();
    234e:	e8 72 1c 00 00       	call   3fc5 <exit>
  }
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2353:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    235a:	00 
    235b:	c7 04 24 6a 51 00 00 	movl   $0x516a,(%esp)
    2362:	e8 9e 1c 00 00       	call   4005 <open>
    2367:	85 c0                	test   %eax,%eax
    2369:	78 19                	js     2384 <subdir+0x41e>
    printf(1, "create dd/xx/ff succeeded!\n");
    236b:	c7 44 24 04 73 51 00 	movl   $0x5173,0x4(%esp)
    2372:	00 
    2373:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    237a:	e8 06 1e 00 00       	call   4185 <printf>
    exit();
    237f:	e8 41 1c 00 00       	call   3fc5 <exit>
  }
  if(open("dd", O_CREATE) >= 0){
    2384:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    238b:	00 
    238c:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    2393:	e8 6d 1c 00 00       	call   4005 <open>
    2398:	85 c0                	test   %eax,%eax
    239a:	78 19                	js     23b5 <subdir+0x44f>
    printf(1, "create dd succeeded!\n");
    239c:	c7 44 24 04 8f 51 00 	movl   $0x518f,0x4(%esp)
    23a3:	00 
    23a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23ab:	e8 d5 1d 00 00       	call   4185 <printf>
    exit();
    23b0:	e8 10 1c 00 00       	call   3fc5 <exit>
  }
  if(open("dd", O_RDWR) >= 0){
    23b5:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    23bc:	00 
    23bd:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    23c4:	e8 3c 1c 00 00       	call   4005 <open>
    23c9:	85 c0                	test   %eax,%eax
    23cb:	78 19                	js     23e6 <subdir+0x480>
    printf(1, "open dd rdwr succeeded!\n");
    23cd:	c7 44 24 04 a5 51 00 	movl   $0x51a5,0x4(%esp)
    23d4:	00 
    23d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23dc:	e8 a4 1d 00 00       	call   4185 <printf>
    exit();
    23e1:	e8 df 1b 00 00       	call   3fc5 <exit>
  }
  if(open("dd", O_WRONLY) >= 0){
    23e6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    23ed:	00 
    23ee:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    23f5:	e8 0b 1c 00 00       	call   4005 <open>
    23fa:	85 c0                	test   %eax,%eax
    23fc:	78 19                	js     2417 <subdir+0x4b1>
    printf(1, "open dd wronly succeeded!\n");
    23fe:	c7 44 24 04 be 51 00 	movl   $0x51be,0x4(%esp)
    2405:	00 
    2406:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    240d:	e8 73 1d 00 00       	call   4185 <printf>
    exit();
    2412:	e8 ae 1b 00 00       	call   3fc5 <exit>
  }
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2417:	c7 44 24 04 d9 51 00 	movl   $0x51d9,0x4(%esp)
    241e:	00 
    241f:	c7 04 24 45 51 00 00 	movl   $0x5145,(%esp)
    2426:	e8 fa 1b 00 00       	call   4025 <link>
    242b:	85 c0                	test   %eax,%eax
    242d:	75 19                	jne    2448 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    242f:	c7 44 24 04 e4 51 00 	movl   $0x51e4,0x4(%esp)
    2436:	00 
    2437:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    243e:	e8 42 1d 00 00       	call   4185 <printf>
    exit();
    2443:	e8 7d 1b 00 00       	call   3fc5 <exit>
  }
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2448:	c7 44 24 04 d9 51 00 	movl   $0x51d9,0x4(%esp)
    244f:	00 
    2450:	c7 04 24 6a 51 00 00 	movl   $0x516a,(%esp)
    2457:	e8 c9 1b 00 00       	call   4025 <link>
    245c:	85 c0                	test   %eax,%eax
    245e:	75 19                	jne    2479 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2460:	c7 44 24 04 08 52 00 	movl   $0x5208,0x4(%esp)
    2467:	00 
    2468:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    246f:	e8 11 1d 00 00       	call   4185 <printf>
    exit();
    2474:	e8 4c 1b 00 00       	call   3fc5 <exit>
  }
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2479:	c7 44 24 04 20 50 00 	movl   $0x5020,0x4(%esp)
    2480:	00 
    2481:	c7 04 24 58 4f 00 00 	movl   $0x4f58,(%esp)
    2488:	e8 98 1b 00 00       	call   4025 <link>
    248d:	85 c0                	test   %eax,%eax
    248f:	75 19                	jne    24aa <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2491:	c7 44 24 04 2c 52 00 	movl   $0x522c,0x4(%esp)
    2498:	00 
    2499:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24a0:	e8 e0 1c 00 00       	call   4185 <printf>
    exit();
    24a5:	e8 1b 1b 00 00       	call   3fc5 <exit>
  }
  if(mkdir("dd/ff/ff") == 0){
    24aa:	c7 04 24 45 51 00 00 	movl   $0x5145,(%esp)
    24b1:	e8 77 1b 00 00       	call   402d <mkdir>
    24b6:	85 c0                	test   %eax,%eax
    24b8:	75 19                	jne    24d3 <subdir+0x56d>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    24ba:	c7 44 24 04 4e 52 00 	movl   $0x524e,0x4(%esp)
    24c1:	00 
    24c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24c9:	e8 b7 1c 00 00       	call   4185 <printf>
    exit();
    24ce:	e8 f2 1a 00 00       	call   3fc5 <exit>
  }
  if(mkdir("dd/xx/ff") == 0){
    24d3:	c7 04 24 6a 51 00 00 	movl   $0x516a,(%esp)
    24da:	e8 4e 1b 00 00       	call   402d <mkdir>
    24df:	85 c0                	test   %eax,%eax
    24e1:	75 19                	jne    24fc <subdir+0x596>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    24e3:	c7 44 24 04 69 52 00 	movl   $0x5269,0x4(%esp)
    24ea:	00 
    24eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24f2:	e8 8e 1c 00 00       	call   4185 <printf>
    exit();
    24f7:	e8 c9 1a 00 00       	call   3fc5 <exit>
  }
  if(mkdir("dd/dd/ffff") == 0){
    24fc:	c7 04 24 20 50 00 00 	movl   $0x5020,(%esp)
    2503:	e8 25 1b 00 00       	call   402d <mkdir>
    2508:	85 c0                	test   %eax,%eax
    250a:	75 19                	jne    2525 <subdir+0x5bf>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    250c:	c7 44 24 04 84 52 00 	movl   $0x5284,0x4(%esp)
    2513:	00 
    2514:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251b:	e8 65 1c 00 00       	call   4185 <printf>
    exit();
    2520:	e8 a0 1a 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd/xx/ff") == 0){
    2525:	c7 04 24 6a 51 00 00 	movl   $0x516a,(%esp)
    252c:	e8 e4 1a 00 00       	call   4015 <unlink>
    2531:	85 c0                	test   %eax,%eax
    2533:	75 19                	jne    254e <subdir+0x5e8>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2535:	c7 44 24 04 a1 52 00 	movl   $0x52a1,0x4(%esp)
    253c:	00 
    253d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2544:	e8 3c 1c 00 00       	call   4185 <printf>
    exit();
    2549:	e8 77 1a 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd/ff/ff") == 0){
    254e:	c7 04 24 45 51 00 00 	movl   $0x5145,(%esp)
    2555:	e8 bb 1a 00 00       	call   4015 <unlink>
    255a:	85 c0                	test   %eax,%eax
    255c:	75 19                	jne    2577 <subdir+0x611>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    255e:	c7 44 24 04 bd 52 00 	movl   $0x52bd,0x4(%esp)
    2565:	00 
    2566:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    256d:	e8 13 1c 00 00       	call   4185 <printf>
    exit();
    2572:	e8 4e 1a 00 00       	call   3fc5 <exit>
  }
  if(chdir("dd/ff") == 0){
    2577:	c7 04 24 58 4f 00 00 	movl   $0x4f58,(%esp)
    257e:	e8 b2 1a 00 00       	call   4035 <chdir>
    2583:	85 c0                	test   %eax,%eax
    2585:	75 19                	jne    25a0 <subdir+0x63a>
    printf(1, "chdir dd/ff succeeded!\n");
    2587:	c7 44 24 04 d9 52 00 	movl   $0x52d9,0x4(%esp)
    258e:	00 
    258f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2596:	e8 ea 1b 00 00       	call   4185 <printf>
    exit();
    259b:	e8 25 1a 00 00       	call   3fc5 <exit>
  }
  if(chdir("dd/xx") == 0){
    25a0:	c7 04 24 f1 52 00 00 	movl   $0x52f1,(%esp)
    25a7:	e8 89 1a 00 00       	call   4035 <chdir>
    25ac:	85 c0                	test   %eax,%eax
    25ae:	75 19                	jne    25c9 <subdir+0x663>
    printf(1, "chdir dd/xx succeeded!\n");
    25b0:	c7 44 24 04 f7 52 00 	movl   $0x52f7,0x4(%esp)
    25b7:	00 
    25b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25bf:	e8 c1 1b 00 00       	call   4185 <printf>
    exit();
    25c4:	e8 fc 19 00 00       	call   3fc5 <exit>
  }

  if(unlink("dd/dd/ffff") != 0){
    25c9:	c7 04 24 20 50 00 00 	movl   $0x5020,(%esp)
    25d0:	e8 40 1a 00 00       	call   4015 <unlink>
    25d5:	85 c0                	test   %eax,%eax
    25d7:	74 19                	je     25f2 <subdir+0x68c>
    printf(1, "unlink dd/dd/ff failed\n");
    25d9:	c7 44 24 04 4d 50 00 	movl   $0x504d,0x4(%esp)
    25e0:	00 
    25e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25e8:	e8 98 1b 00 00       	call   4185 <printf>
    exit();
    25ed:	e8 d3 19 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd/ff") != 0){
    25f2:	c7 04 24 58 4f 00 00 	movl   $0x4f58,(%esp)
    25f9:	e8 17 1a 00 00       	call   4015 <unlink>
    25fe:	85 c0                	test   %eax,%eax
    2600:	74 19                	je     261b <subdir+0x6b5>
    printf(1, "unlink dd/ff failed\n");
    2602:	c7 44 24 04 0f 53 00 	movl   $0x530f,0x4(%esp)
    2609:	00 
    260a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2611:	e8 6f 1b 00 00       	call   4185 <printf>
    exit();
    2616:	e8 aa 19 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd") == 0){
    261b:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    2622:	e8 ee 19 00 00       	call   4015 <unlink>
    2627:	85 c0                	test   %eax,%eax
    2629:	75 19                	jne    2644 <subdir+0x6de>
    printf(1, "unlink non-empty dd succeeded!\n");
    262b:	c7 44 24 04 24 53 00 	movl   $0x5324,0x4(%esp)
    2632:	00 
    2633:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    263a:	e8 46 1b 00 00       	call   4185 <printf>
    exit();
    263f:	e8 81 19 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd/dd") < 0){
    2644:	c7 04 24 44 53 00 00 	movl   $0x5344,(%esp)
    264b:	e8 c5 19 00 00       	call   4015 <unlink>
    2650:	85 c0                	test   %eax,%eax
    2652:	79 19                	jns    266d <subdir+0x707>
    printf(1, "unlink dd/dd failed\n");
    2654:	c7 44 24 04 4a 53 00 	movl   $0x534a,0x4(%esp)
    265b:	00 
    265c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2663:	e8 1d 1b 00 00       	call   4185 <printf>
    exit();
    2668:	e8 58 19 00 00       	call   3fc5 <exit>
  }
  if(unlink("dd") < 0){
    266d:	c7 04 24 3d 4f 00 00 	movl   $0x4f3d,(%esp)
    2674:	e8 9c 19 00 00       	call   4015 <unlink>
    2679:	85 c0                	test   %eax,%eax
    267b:	79 19                	jns    2696 <subdir+0x730>
    printf(1, "unlink dd failed\n");
    267d:	c7 44 24 04 5f 53 00 	movl   $0x535f,0x4(%esp)
    2684:	00 
    2685:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    268c:	e8 f4 1a 00 00       	call   4185 <printf>
    exit();
    2691:	e8 2f 19 00 00       	call   3fc5 <exit>
  }

  printf(1, "subdir ok\n");
    2696:	c7 44 24 04 71 53 00 	movl   $0x5371,0x4(%esp)
    269d:	00 
    269e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26a5:	e8 db 1a 00 00       	call   4185 <printf>
}
    26aa:	c9                   	leave  
    26ab:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 7c 53 00 	movl   $0x537c,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 bf 1a 00 00       	call   4185 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 8b 53 00 00 	movl   $0x538b,(%esp)
    26cd:	e8 43 19 00 00       	call   4015 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 8b 53 00 00 	movl   $0x538b,(%esp)
    26ed:	e8 13 19 00 00       	call   4005 <open>
    26f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(fd < 0){
    26f5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    26f9:	79 19                	jns    2714 <bigwrite+0x68>
      printf(1, "cannot create bigwrite\n");
    26fb:	c7 44 24 04 94 53 00 	movl   $0x5394,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 76 1a 00 00       	call   4185 <printf>
      exit();
    270f:	e8 b1 18 00 00       	call   3fc5 <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2732:	e8 ae 18 00 00       	call   3fe5 <write>
    ...
    2750:	c7 44 24 04 ac 53 00 	movl   $0x53ac,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 21 1a 00 00       	call   4185 <printf>
        exit();
    2764:	e8 5c 18 00 00       	call   3fc5 <exit>
    if(fd < 0){
      printf(1, "cannot create bigwrite\n");
      exit();
    }
    ...
    2779:	e8 6f 18 00 00       	call   3fed <close>
    unlink("bigwrite");
    277e:	c7 04 24 8b 53 00 00 	movl   $0x538b,(%esp)
    2785:	e8 8b 18 00 00       	call   4015 <unlink>
  int fd, sz;
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 be 53 00 	movl   $0x53be,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 d3 19 00 00       	call   4185 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 cb 53 00 	movl   $0x53cb,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 b7 19 00 00       	call   4185 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 d9 53 00 00 	movl   $0x53d9,(%esp)
    27d5:	e8 3b 18 00 00       	call   4015 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 d9 53 00 00 	movl   $0x53d9,(%esp)
    27e9:	e8 17 18 00 00       	call   4005 <open>
    27ee:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    27f1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    27f5:	79 19                	jns    2810 <bigfile+0x5c>
    printf(1, "cannot create bigfile");
    27f7:	c7 44 24 04 e1 53 00 	movl   $0x53e1,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 7a 19 00 00       	call   4185 <printf>
    exit();
    280b:	e8 b5 17 00 00       	call   3fc5 <exit>
  }
  for(i = 0; i < 20; i++){
    ...
    282f:	e8 e4 15 00 00       	call   3e18 <memset>
    ...
    284a:	e8 96 17 00 00       	call   3fe5 <write>
    284f:	3d 58 02 00 00       	cmp    $0x258,%eax
    2854:	74 19                	je     286f <bigfile+0xbb>
      printf(1, "write bigfile failed\n");
    2856:	c7 44 24 04 f7 53 00 	movl   $0x53f7,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 1b 19 00 00       	call   4185 <printf>
      exit();
    286a:	e8 56 17 00 00       	call   3fc5 <exit>
  fd = open("bigfile", O_CREATE | O_RDWR);
  if(fd < 0){
    printf(1, "cannot create bigfile");
    exit();
  ...
  close(fd);
    ...
    287f:	e8 69 17 00 00       	call   3fed <close>

  fd = open("bigfile", 0);
    2884:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    288b:	00 
    288c:	c7 04 24 d9 53 00 00 	movl   $0x53d9,(%esp)
    2893:	e8 6d 17 00 00       	call   4005 <open>
    2898:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    289b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    289f:	79 19                	jns    28ba <bigfile+0x106>
    printf(1, "cannot open bigfile\n");
    28a1:	c7 44 24 04 0d 54 00 	movl   $0x540d,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 d0 18 00 00       	call   4185 <printf>
    exit();
    28b5:	e8 0b 17 00 00       	call   3fc5 <exit>
  }
  total = 0;
  ...
  for(i = 0; ; i++){
    ...
    28de:	e8 fa 16 00 00       	call   3fdd <read>
    28e3:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(cc < 0){
    28e6:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    28ea:	79 19                	jns    2905 <bigfile+0x151>
      printf(1, "read bigfile failed\n");
    28ec:	c7 44 24 04 22 54 00 	movl   $0x5422,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 85 18 00 00       	call   4185 <printf>
      exit();
    2900:	e8 c0 16 00 00       	call   3fc5 <exit>
    }
    if(cc == 0)
  ...
  close(fd);
    ...
    2912:	e8 d6 16 00 00       	call   3fed <close>
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 37 54 00 	movl   $0x5437,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 42 18 00 00       	call   4185 <printf>
      exit();
    2943:	e8 7d 16 00 00       	call   3fc5 <exit>
    }
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 4b 54 00 	movl   $0x544b,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 f5 17 00 00       	call   4185 <printf>
      exit();
    2990:	e8 30 16 00 00       	call   3fc5 <exit>
    }
    total += cc;
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 64 54 00 	movl   $0x5464,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 cd 17 00 00       	call   4185 <printf>
    exit();
    29b8:	e8 08 16 00 00       	call   3fc5 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 d9 53 00 00 	movl   $0x53d9,(%esp)
    29c4:	e8 4c 16 00 00       	call   4015 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 7e 54 00 	movl   $0x547e,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 a8 17 00 00       	call   4185 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    29e5:	c7 44 24 04 8f 54 00 	movl   $0x548f,0x4(%esp)
    29ec:	00 
    29ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29f4:	e8 8c 17 00 00       	call   4185 <printf>

  if(mkdir("12345678901234") != 0){
    29f9:	c7 04 24 9e 54 00 00 	movl   $0x549e,(%esp)
    2a00:	e8 28 16 00 00       	call   402d <mkdir>
    2a05:	85 c0                	test   %eax,%eax
    2a07:	74 19                	je     2a22 <fourteen+0x43>
    printf(1, "mkdir 12345678901234 failed\n");
    2a09:	c7 44 24 04 ad 54 00 	movl   $0x54ad,0x4(%esp)
    2a10:	00 
    2a11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a18:	e8 68 17 00 00       	call   4185 <printf>
    exit();
    2a1d:	e8 a3 15 00 00       	call   3fc5 <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    2a22:	c7 04 24 cc 54 00 00 	movl   $0x54cc,(%esp)
    2a29:	e8 ff 15 00 00       	call   402d <mkdir>
    2a2e:	85 c0                	test   %eax,%eax
    2a30:	74 19                	je     2a4b <fourteen+0x6c>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2a32:	c7 44 24 04 ec 54 00 	movl   $0x54ec,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a41:	e8 3f 17 00 00       	call   4185 <printf>
    exit();
    2a46:	e8 7a 15 00 00       	call   3fc5 <exit>
  }
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    2a4b:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a52:	00 
    2a53:	c7 04 24 1c 55 00 00 	movl   $0x551c,(%esp)
    2a5a:	e8 a6 15 00 00       	call   4005 <open>
    2a5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2a62:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2a66:	79 19                	jns    2a81 <fourteen+0xa2>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    2a68:	c7 44 24 04 4c 55 00 	movl   $0x554c,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 09 17 00 00       	call   4185 <printf>
    exit();
    2a7c:	e8 44 15 00 00       	call   3fc5 <exit>
  }
  close(fd);
    2a81:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2a84:	89 04 24             	mov    %eax,(%esp)
    2a87:	e8 61 15 00 00       	call   3fed <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2a8c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2a93:	00 
    2a94:	c7 04 24 8c 55 00 00 	movl   $0x558c,(%esp)
    2a9b:	e8 65 15 00 00       	call   4005 <open>
    2aa0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2aa3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2aa7:	79 19                	jns    2ac2 <fourteen+0xe3>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2aa9:	c7 44 24 04 bc 55 00 	movl   $0x55bc,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 c8 16 00 00       	call   4185 <printf>
    exit();
    2abd:	e8 03 15 00 00       	call   3fc5 <exit>
  }
  close(fd);
    2ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ac5:	89 04 24             	mov    %eax,(%esp)
    2ac8:	e8 20 15 00 00       	call   3fed <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2acd:	c7 04 24 f6 55 00 00 	movl   $0x55f6,(%esp)
    2ad4:	e8 54 15 00 00       	call   402d <mkdir>
    2ad9:	85 c0                	test   %eax,%eax
    2adb:	75 19                	jne    2af6 <fourteen+0x117>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2add:	c7 44 24 04 14 56 00 	movl   $0x5614,0x4(%esp)
    2ae4:	00 
    2ae5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2aec:	e8 94 16 00 00       	call   4185 <printf>
    exit();
    2af1:	e8 cf 14 00 00       	call   3fc5 <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    2af6:	c7 04 24 44 56 00 00 	movl   $0x5644,(%esp)
    2afd:	e8 2b 15 00 00       	call   402d <mkdir>
    2b02:	85 c0                	test   %eax,%eax
    2b04:	75 19                	jne    2b1f <fourteen+0x140>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2b06:	c7 44 24 04 64 56 00 	movl   $0x5664,0x4(%esp)
    2b0d:	00 
    2b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b15:	e8 6b 16 00 00       	call   4185 <printf>
    exit();
    2b1a:	e8 a6 14 00 00       	call   3fc5 <exit>
  }

  printf(1, "fourteen ok\n");
    2b1f:	c7 44 24 04 95 56 00 	movl   $0x5695,0x4(%esp)
    2b26:	00 
    2b27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b2e:	e8 52 16 00 00       	call   4185 <printf>
}
    2b33:	c9                   	leave  
    2b34:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    2b3b:	c7 44 24 04 a2 56 00 	movl   $0x56a2,0x4(%esp)
    2b42:	00 
    2b43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b4a:	e8 36 16 00 00       	call   4185 <printf>
  if(mkdir("dots") != 0){
    2b4f:	c7 04 24 ae 56 00 00 	movl   $0x56ae,(%esp)
    2b56:	e8 d2 14 00 00       	call   402d <mkdir>
    2b5b:	85 c0                	test   %eax,%eax
    2b5d:	74 19                	je     2b78 <rmdot+0x43>
    printf(1, "mkdir dots failed\n");
    2b5f:	c7 44 24 04 b3 56 00 	movl   $0x56b3,0x4(%esp)
    2b66:	00 
    2b67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b6e:	e8 12 16 00 00       	call   4185 <printf>
    exit();
    2b73:	e8 4d 14 00 00       	call   3fc5 <exit>
  }
  if(chdir("dots") != 0){
    2b78:	c7 04 24 ae 56 00 00 	movl   $0x56ae,(%esp)
    2b7f:	e8 b1 14 00 00       	call   4035 <chdir>
    2b84:	85 c0                	test   %eax,%eax
    2b86:	74 19                	je     2ba1 <rmdot+0x6c>
    printf(1, "chdir dots failed\n");
    2b88:	c7 44 24 04 c6 56 00 	movl   $0x56c6,0x4(%esp)
    2b8f:	00 
    2b90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b97:	e8 e9 15 00 00       	call   4185 <printf>
    exit();
    2b9c:	e8 24 14 00 00       	call   3fc5 <exit>
  }
  if(unlink(".") == 0){
    2ba1:	c7 04 24 df 4d 00 00 	movl   $0x4ddf,(%esp)
    2ba8:	e8 68 14 00 00       	call   4015 <unlink>
    2bad:	85 c0                	test   %eax,%eax
    2baf:	75 19                	jne    2bca <rmdot+0x95>
    printf(1, "rm . worked!\n");
    2bb1:	c7 44 24 04 d9 56 00 	movl   $0x56d9,0x4(%esp)
    2bb8:	00 
    2bb9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bc0:	e8 c0 15 00 00       	call   4185 <printf>
    exit();
    2bc5:	e8 fb 13 00 00       	call   3fc5 <exit>
  }
  if(unlink("..") == 0){
    2bca:	c7 04 24 72 49 00 00 	movl   $0x4972,(%esp)
    2bd1:	e8 3f 14 00 00       	call   4015 <unlink>
    2bd6:	85 c0                	test   %eax,%eax
    2bd8:	75 19                	jne    2bf3 <rmdot+0xbe>
    printf(1, "rm .. worked!\n");
    2bda:	c7 44 24 04 e7 56 00 	movl   $0x56e7,0x4(%esp)
    2be1:	00 
    2be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be9:	e8 97 15 00 00       	call   4185 <printf>
    exit();
    2bee:	e8 d2 13 00 00       	call   3fc5 <exit>
  }
  if(chdir("/") != 0){
    2bf3:	c7 04 24 c6 45 00 00 	movl   $0x45c6,(%esp)
    2bfa:	e8 36 14 00 00       	call   4035 <chdir>
    2bff:	85 c0                	test   %eax,%eax
    2c01:	74 19                	je     2c1c <rmdot+0xe7>
    printf(1, "chdir / failed\n");
    2c03:	c7 44 24 04 c8 45 00 	movl   $0x45c8,0x4(%esp)
    2c0a:	00 
    2c0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c12:	e8 6e 15 00 00       	call   4185 <printf>
    exit();
    2c17:	e8 a9 13 00 00       	call   3fc5 <exit>
  }
  if(unlink("dots/.") == 0){
    2c1c:	c7 04 24 f6 56 00 00 	movl   $0x56f6,(%esp)
    2c23:	e8 ed 13 00 00       	call   4015 <unlink>
    2c28:	85 c0                	test   %eax,%eax
    2c2a:	75 19                	jne    2c45 <rmdot+0x110>
    printf(1, "unlink dots/. worked!\n");
    2c2c:	c7 44 24 04 fd 56 00 	movl   $0x56fd,0x4(%esp)
    2c33:	00 
    2c34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c3b:	e8 45 15 00 00       	call   4185 <printf>
    exit();
    2c40:	e8 80 13 00 00       	call   3fc5 <exit>
  }
  if(unlink("dots/..") == 0){
    2c45:	c7 04 24 14 57 00 00 	movl   $0x5714,(%esp)
    2c4c:	e8 c4 13 00 00       	call   4015 <unlink>
    2c51:	85 c0                	test   %eax,%eax
    2c53:	75 19                	jne    2c6e <rmdot+0x139>
    printf(1, "unlink dots/.. worked!\n");
    2c55:	c7 44 24 04 1c 57 00 	movl   $0x571c,0x4(%esp)
    2c5c:	00 
    2c5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c64:	e8 1c 15 00 00       	call   4185 <printf>
    exit();
    2c69:	e8 57 13 00 00       	call   3fc5 <exit>
  }
  if(unlink("dots") != 0){
    2c6e:	c7 04 24 ae 56 00 00 	movl   $0x56ae,(%esp)
    2c75:	e8 9b 13 00 00       	call   4015 <unlink>
    2c7a:	85 c0                	test   %eax,%eax
    2c7c:	74 19                	je     2c97 <rmdot+0x162>
    printf(1, "unlink dots failed!\n");
    2c7e:	c7 44 24 04 34 57 00 	movl   $0x5734,0x4(%esp)
    2c85:	00 
    2c86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c8d:	e8 f3 14 00 00       	call   4185 <printf>
    exit();
    2c92:	e8 2e 13 00 00       	call   3fc5 <exit>
  }
  printf(1, "rmdot ok\n");
    2c97:	c7 44 24 04 49 57 00 	movl   $0x5749,0x4(%esp)
    2c9e:	00 
    2c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ca6:	e8 da 14 00 00       	call   4185 <printf>
}
    2cab:	c9                   	leave  
    2cac:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 53 57 00 	movl   $0x5753,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 be 14 00 00       	call   4185 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 60 57 00 00 	movl   $0x5760,(%esp)
    2cd6:	e8 2a 13 00 00       	call   4005 <open>
    2cdb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2cde:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2ce2:	79 19                	jns    2cfd <dirfile+0x50>
    printf(1, "create dirfile failed\n");
    2ce4:	c7 44 24 04 68 57 00 	movl   $0x5768,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 8d 14 00 00       	call   4185 <printf>
    exit();
    2cf8:	e8 c8 12 00 00       	call   3fc5 <exit>
  }
  close(fd);
    2cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2d00:	89 04 24             	mov    %eax,(%esp)
    2d03:	e8 e5 12 00 00       	call   3fed <close>
  if(chdir("dirfile") == 0){
    2d08:	c7 04 24 60 57 00 00 	movl   $0x5760,(%esp)
    2d0f:	e8 21 13 00 00       	call   4035 <chdir>
    2d14:	85 c0                	test   %eax,%eax
    2d16:	75 19                	jne    2d31 <dirfile+0x84>
    printf(1, "chdir dirfile succeeded!\n");
    2d18:	c7 44 24 04 7f 57 00 	movl   $0x577f,0x4(%esp)
    2d1f:	00 
    2d20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d27:	e8 59 14 00 00       	call   4185 <printf>
    exit();
    2d2c:	e8 94 12 00 00       	call   3fc5 <exit>
  }
  fd = open("dirfile/xx", 0);
    2d31:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2d38:	00 
    2d39:	c7 04 24 99 57 00 00 	movl   $0x5799,(%esp)
    2d40:	e8 c0 12 00 00       	call   4005 <open>
    2d45:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d48:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d4c:	78 19                	js     2d67 <dirfile+0xba>
    printf(1, "create dirfile/xx succeeded!\n");
    2d4e:	c7 44 24 04 a4 57 00 	movl   $0x57a4,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 23 14 00 00       	call   4185 <printf>
    exit();
    2d62:	e8 5e 12 00 00       	call   3fc5 <exit>
  }
  fd = open("dirfile/xx", O_CREATE);
    2d67:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d6e:	00 
    2d6f:	c7 04 24 99 57 00 00 	movl   $0x5799,(%esp)
    2d76:	e8 8a 12 00 00       	call   4005 <open>
    2d7b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d7e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d82:	78 19                	js     2d9d <dirfile+0xf0>
    printf(1, "create dirfile/xx succeeded!\n");
    2d84:	c7 44 24 04 a4 57 00 	movl   $0x57a4,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 ed 13 00 00       	call   4185 <printf>
    exit();
    2d98:	e8 28 12 00 00       	call   3fc5 <exit>
  }
  if(mkdir("dirfile/xx") == 0){
    2d9d:	c7 04 24 99 57 00 00 	movl   $0x5799,(%esp)
    2da4:	e8 84 12 00 00       	call   402d <mkdir>
    2da9:	85 c0                	test   %eax,%eax
    2dab:	75 19                	jne    2dc6 <dirfile+0x119>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2dad:	c7 44 24 04 c2 57 00 	movl   $0x57c2,0x4(%esp)
    2db4:	00 
    2db5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbc:	e8 c4 13 00 00       	call   4185 <printf>
    exit();
    2dc1:	e8 ff 11 00 00       	call   3fc5 <exit>
  }
  if(unlink("dirfile/xx") == 0){
    2dc6:	c7 04 24 99 57 00 00 	movl   $0x5799,(%esp)
    2dcd:	e8 43 12 00 00       	call   4015 <unlink>
    2dd2:	85 c0                	test   %eax,%eax
    2dd4:	75 19                	jne    2def <dirfile+0x142>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2dd6:	c7 44 24 04 df 57 00 	movl   $0x57df,0x4(%esp)
    2ddd:	00 
    2dde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de5:	e8 9b 13 00 00       	call   4185 <printf>
    exit();
    2dea:	e8 d6 11 00 00       	call   3fc5 <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    2def:	c7 44 24 04 99 57 00 	movl   $0x5799,0x4(%esp)
    2df6:	00 
    2df7:	c7 04 24 fd 57 00 00 	movl   $0x57fd,(%esp)
    2dfe:	e8 22 12 00 00       	call   4025 <link>
    2e03:	85 c0                	test   %eax,%eax
    2e05:	75 19                	jne    2e20 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2e07:	c7 44 24 04 04 58 00 	movl   $0x5804,0x4(%esp)
    2e0e:	00 
    2e0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e16:	e8 6a 13 00 00       	call   4185 <printf>
    exit();
    2e1b:	e8 a5 11 00 00       	call   3fc5 <exit>
  }
  if(unlink("dirfile") != 0){
    2e20:	c7 04 24 60 57 00 00 	movl   $0x5760,(%esp)
    2e27:	e8 e9 11 00 00       	call   4015 <unlink>
    2e2c:	85 c0                	test   %eax,%eax
    2e2e:	74 19                	je     2e49 <dirfile+0x19c>
    printf(1, "unlink dirfile failed!\n");
    2e30:	c7 44 24 04 23 58 00 	movl   $0x5823,0x4(%esp)
    2e37:	00 
    2e38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e3f:	e8 41 13 00 00       	call   4185 <printf>
    exit();
    2e44:	e8 7c 11 00 00       	call   3fc5 <exit>
  }

  fd = open(".", O_RDWR);
    2e49:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    2e50:	00 
    2e51:	c7 04 24 df 4d 00 00 	movl   $0x4ddf,(%esp)
    2e58:	e8 a8 11 00 00       	call   4005 <open>
    2e5d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2e60:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2e64:	78 19                	js     2e7f <dirfile+0x1d2>
    printf(1, "open . for writing succeeded!\n");
    2e66:	c7 44 24 04 3c 58 00 	movl   $0x583c,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 0b 13 00 00       	call   4185 <printf>
    exit();
    2e7a:	e8 46 11 00 00       	call   3fc5 <exit>
  }
  fd = open(".", 0);
    2e7f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2e86:	00 
    2e87:	c7 04 24 df 4d 00 00 	movl   $0x4ddf,(%esp)
    2e8e:	e8 72 11 00 00       	call   4005 <open>
    2e93:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(write(fd, "x", 1) > 0){
    2e96:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2e9d:	00 
    2e9e:	c7 44 24 04 2b 4a 00 	movl   $0x4a2b,0x4(%esp)
    2ea5:	00 
    2ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ea9:	89 04 24             	mov    %eax,(%esp)
    2eac:	e8 34 11 00 00       	call   3fe5 <write>
    2eb1:	85 c0                	test   %eax,%eax
    2eb3:	7e 19                	jle    2ece <dirfile+0x221>
    printf(1, "write . succeeded!\n");
    2eb5:	c7 44 24 04 5b 58 00 	movl   $0x585b,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 bc 12 00 00       	call   4185 <printf>
    exit();
    2ec9:	e8 f7 10 00 00       	call   3fc5 <exit>
  }
  close(fd);
    2ece:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ed1:	89 04 24             	mov    %eax,(%esp)
    2ed4:	e8 14 11 00 00       	call   3fed <close>

  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 6f 58 00 	movl   $0x586f,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 98 12 00 00       	call   4185 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 7f 58 00 	movl   $0x587f,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 7c 12 00 00       	call   4185 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(mkdir("irefd") != 0){
    2f15:	c7 04 24 90 58 00 00 	movl   $0x5890,(%esp)
    2f1c:	e8 0c 11 00 00       	call   402d <mkdir>
    2f21:	85 c0                	test   %eax,%eax
    2f23:	74 19                	je     2f3e <iref+0x4f>
      printf(1, "mkdir irefd failed\n");
    2f25:	c7 44 24 04 96 58 00 	movl   $0x5896,0x4(%esp)
    2f2c:	00 
    2f2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f34:	e8 4c 12 00 00       	call   4185 <printf>
      exit();
    2f39:	e8 87 10 00 00       	call   3fc5 <exit>
    }
    if(chdir("irefd") != 0){
    2f3e:	c7 04 24 90 58 00 00 	movl   $0x5890,(%esp)
    2f45:	e8 eb 10 00 00       	call   4035 <chdir>
    2f4a:	85 c0                	test   %eax,%eax
    2f4c:	74 19                	je     2f67 <iref+0x78>
      printf(1, "chdir irefd failed\n");
    2f4e:	c7 44 24 04 aa 58 00 	movl   $0x58aa,0x4(%esp)
    2f55:	00 
    2f56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f5d:	e8 23 12 00 00       	call   4185 <printf>
      exit();
    2f62:	e8 5e 10 00 00       	call   3fc5 <exit>
    }

    mkdir("");
    2f67:	c7 04 24 be 58 00 00 	movl   $0x58be,(%esp)
    2f6e:	e8 ba 10 00 00       	call   402d <mkdir>
    link("README", "");
    2f73:	c7 44 24 04 be 58 00 	movl   $0x58be,0x4(%esp)
    2f7a:	00 
    2f7b:	c7 04 24 fd 57 00 00 	movl   $0x57fd,(%esp)
    2f82:	e8 9e 10 00 00       	call   4025 <link>
    fd = open("", O_CREATE);
    2f87:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2f8e:	00 
    2f8f:	c7 04 24 be 58 00 00 	movl   $0x58be,(%esp)
    2f96:	e8 6a 10 00 00       	call   4005 <open>
    ...
    2faa:	e8 3e 10 00 00       	call   3fed <close>
    fd = open("xx", O_CREATE);
    2faf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2fb6:	00 
    2fb7:	c7 04 24 bf 58 00 00 	movl   $0x58bf,(%esp)
    2fbe:	e8 42 10 00 00       	call   4005 <open>
    ...
    2fd2:	e8 16 10 00 00       	call   3fed <close>
    unlink("xx");
    2fd7:	c7 04 24 bf 58 00 00 	movl   $0x58bf,(%esp)
    2fde:	e8 32 10 00 00       	call   4015 <unlink>
  int i, fd;
  ...
  chdir("/");
    2ff1:	c7 04 24 c6 45 00 00 	movl   $0x45c6,(%esp)
    2ff8:	e8 38 10 00 00       	call   4035 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 c2 58 00 	movl   $0x58c2,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 74 11 00 00       	call   4185 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 d6 58 00 	movl   $0x58d6,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 58 11 00 00       	call   4185 <printf>

  for(n=0; n<1000; n++){
    302d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3034:	eb 1f                	jmp    3055 <forktest+0x42>
    pid = fork();
    3036:	e8 82 0f 00 00       	call   3fbd <fork>
    ...
    304a:	75 05                	jne    3051 <forktest+0x3e>
      exit();
    304c:	e8 74 0f 00 00       	call   3fc5 <exit>
{
  int n, pid;
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 e4 58 00 	movl   $0x58e4,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 0a 11 00 00       	call   4185 <printf>
    exit();
    307b:	e8 45 0f 00 00       	call   3fc5 <exit>
  }
  
  for(; n > 0; n--){
    3080:	eb 26                	jmp    30a8 <forktest+0x95>
    if(wait() < 0){
    3082:	e8 46 0f 00 00       	call   3fcd <wait>
    3087:	85 c0                	test   %eax,%eax
    3089:	79 19                	jns    30a4 <forktest+0x91>
      printf(1, "wait stopped early\n");
    308b:	c7 44 24 04 06 59 00 	movl   $0x5906,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 e6 10 00 00       	call   4185 <printf>
      exit();
    309f:	e8 21 0f 00 00       	call   3fc5 <exit>
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
    exit();
  }
  ...
  if(wait() != -1){
    30ae:	e8 1a 0f 00 00       	call   3fcd <wait>
    30b3:	83 f8 ff             	cmp    $0xffffffff,%eax
    30b6:	74 19                	je     30d1 <forktest+0xbe>
    printf(1, "wait got too many\n");
    30b8:	c7 44 24 04 1a 59 00 	movl   $0x591a,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 b9 10 00 00       	call   4185 <printf>
    exit();
    30cc:	e8 f4 0e 00 00       	call   3fc5 <exit>
  }
  
  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 2d 59 00 	movl   $0x592d,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 a0 10 00 00       	call   4185 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    30f6:	c7 44 24 04 3b 59 00 	movl   $0x593b,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 7f 10 00 00       	call   4185 <printf>
  oldbrk = sbrk(0);
    3106:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    310d:	e8 3b 0f 00 00       	call   404d <sbrk>
    3112:	89 45 ec             	mov    %eax,-0x14(%ebp)

  // can one sbrk() less than a page?
  a = sbrk(0);
    3115:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    311c:	e8 2c 0f 00 00       	call   404d <sbrk>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3134:	e8 14 0f 00 00       	call   404d <sbrk>
    ...
    315e:	c7 44 24 04 46 59 00 	movl   $0x5946,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 17 10 00 00       	call   4185 <printf>
      exit();
    316e:	e8 52 0e 00 00       	call   3fc5 <exit>
    }
    *b = 1;
  ...
  pid = fork();
    318f:	e8 29 0e 00 00       	call   3fbd <fork>
  ...
  if(pid < 0){
    ...
    31a2:	c7 44 24 04 61 59 00 	movl   $0x5961,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 d3 0f 00 00       	call   4185 <printf>
    exit();
    31b2:	e8 0e 0e 00 00       	call   3fc5 <exit>
  }
  c = sbrk(1);
    31b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31be:	e8 8a 0e 00 00       	call   404d <sbrk>
    31c3:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    31c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31cd:	e8 7b 0e 00 00       	call   404d <sbrk>
  ...
  if(c != a + 1){
    ...
    31e5:	c7 44 24 04 78 59 00 	movl   $0x5978,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 90 0f 00 00       	call   4185 <printf>
    exit();
    31f5:	e8 cb 0d 00 00       	call   3fc5 <exit>
  }
  if(pid == 0)
    31fa:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    31fe:	75 05                	jne    3205 <sbrktest+0x11e>
    exit();
    3200:	e8 c0 0d 00 00       	call   3fc5 <exit>
  wait();
    3205:	e8 c3 0d 00 00       	call   3fcd <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    320a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3211:	e8 37 0e 00 00       	call   404d <sbrk>
  ...
  p = sbrk(amt);
    ...
    322e:	e8 1a 0e 00 00       	call   404d <sbrk>
  ...
  if (p != a) { 
    ...
    3243:	c7 44 24 04 94 59 00 	movl   $0x5994,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 32 0f 00 00       	call   4185 <printf>
    exit();
    3253:	e8 6d 0d 00 00       	call   3fc5 <exit>
  }
  lastaddr = (char*) (BIG-1);
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    328e:	c7 44 24 04 d2 59 00 	movl   $0x59d2,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 e7 0e 00 00       	call   4185 <printf>
    exit();
    329e:	e8 22 0d 00 00       	call   3fc5 <exit>
  }
  c = sbrk(0);
    32a3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    32aa:	e8 9e 0d 00 00       	call   404d <sbrk>
  ...
  if(c != a - 4096){
    ...
    32d2:	c7 44 24 04 f0 59 00 	movl   $0x59f0,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 a3 0e 00 00       	call   4185 <printf>
    exit();
    32e2:	e8 de 0c 00 00       	call   3fc5 <exit>
  }

  // can one re-allocate that page?
  a = sbrk(0);
    32e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    32ee:	e8 5a 0d 00 00       	call   404d <sbrk>
    32f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c = sbrk(4096);
    32f6:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    32fd:	e8 4b 0d 00 00       	call   404d <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3314:	e8 34 0d 00 00       	call   404d <sbrk>
    ...
    3339:	c7 44 24 04 28 5a 00 	movl   $0x5a28,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 3c 0e 00 00       	call   4185 <printf>
    exit();
    3349:	e8 77 0c 00 00       	call   3fc5 <exit>
  }
  if(*lastaddr == 99){
  ...
  if(c != a){
    ...
    33ba:	c7 44 24 04 80 5a 00 	movl   $0x5a80,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 bb 0d 00 00       	call   4185 <printf>
    exit();
    33ca:	e8 f6 0b 00 00       	call   3fc5 <exit>
  }
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    33d8:	e8 68 0c 00 00       	call   4045 <getpid>
    33dd:	89 45 d0             	mov    %eax,-0x30(%ebp)
    pid = fork();
    33e0:	e8 d8 0b 00 00       	call   3fbd <fork>
    ...
    33f3:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 82 0d 00 00       	call   4185 <printf>
      exit();
    3403:	e8 bd 0b 00 00       	call   3fc5 <exit>
    }
    if(pid == 0){
    ...
    3427:	c7 44 24 04 a1 5a 00 	movl   $0x5aa1,0x4(%esp)
    342e:	00 
    342f:	89 04 24             	mov    %eax,(%esp)
    3432:	e8 4e 0d 00 00       	call   4185 <printf>
      kill(ppid);
    3437:	8b 45 d0             	mov    -0x30(%ebp),%eax
    343a:	89 04 24             	mov    %eax,(%esp)
    343d:	e8 b3 0b 00 00       	call   3ff5 <kill>
      exit();
    3442:	e8 7e 0b 00 00       	call   3fc5 <exit>
    }
    wait();
    3447:	e8 81 0b 00 00       	call   3fcd <wait>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    exit();
  }
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3512:	e8 c6 0a 00 00       	call   3fdd <read>
  // failed allocation?
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    exit();
  ...
  c = sbrk(4096);
    ...
    352e:	e8 1a 0b 00 00       	call   404d <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3557:	e8 99 0a 00 00       	call   3ff5 <kill>
    wait();
    355c:	e8 6c 0a 00 00       	call   3fcd <wait>
      read(fds[0], &scratch, 1);
  }
  // if those failed allocations freed up the pages they did allocate,
  // we'll be able to allocate here
  ...
  if(c == (char*)0xffffffff){
    ...
    3578:	c7 44 24 04 ba 5a 00 	movl   $0x5aba,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 fd 0b 00 00       	call   4185 <printf>
    exit();
    3588:	e8 38 0a 00 00       	call   3fc5 <exit>
  }

  if(sbrk(0) > oldbrk)
    358d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3594:	e8 b4 0a 00 00       	call   404d <sbrk>
    ...
    35a8:	e8 a0 0a 00 00       	call   404d <sbrk>
    35ad:	29 c3                	sub    %eax,%ebx
    35af:	89 d8                	mov    %ebx,%eax
    35b1:	89 04 24             	mov    %eax,(%esp)
    35b4:	e8 94 0a 00 00       	call   404d <sbrk>

  printf(stdout, "sbrk test OK\n");
    35b9:	a1 a8 64 00 00       	mov    0x64a8,%eax
    35be:	c7 44 24 04 d5 5a 00 	movl   $0x5ad5,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 b7 0b 00 00       	call   4185 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    3604:	c7 44 24 04 e3 5a 00 	movl   $0x5ae3,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 71 0b 00 00       	call   4185 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    3624:	e8 94 09 00 00       	call   3fbd <fork>
    ...
    3638:	e8 9a ff ff ff       	call   35d7 <validateint>
      exit();
    363d:	e8 83 09 00 00       	call   3fc5 <exit>
    }
    sleep(0);
    3642:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3649:	e8 07 0a 00 00       	call   4055 <sleep>
    sleep(0);
    364e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3655:	e8 fb 09 00 00       	call   4055 <sleep>
    kill(pid);
    365a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    365d:	89 04 24             	mov    %eax,(%esp)
    3660:	e8 90 09 00 00       	call   3ff5 <kill>
    wait();
    3665:	e8 63 09 00 00       	call   3fcd <wait>

    // try to crash the kernel by passing in a bad string pointer
    if(link("nosuchfile", (char*)p) != -1){
    366a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    366d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3671:	c7 04 24 f2 5a 00 00 	movl   $0x5af2,(%esp)
    3678:	e8 a8 09 00 00       	call   4025 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 a8 64 00 00       	mov    0x64a8,%eax
    3687:	c7 44 24 04 fd 5a 00 	movl   $0x5afd,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 ee 0a 00 00       	call   4185 <printf>
      exit();
    3697:	e8 29 09 00 00       	call   3fc5 <exit>
  uint p;
  ...
  printf(stdout, "validate ok\n");
    ...
    36b4:	c7 44 24 04 16 5b 00 	movl   $0x5b16,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 c1 0a 00 00       	call   4185 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    36d1:	c7 44 24 04 23 5b 00 	movl   $0x5b23,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 a4 0a 00 00       	call   4185 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36fe:	c7 44 24 04 2d 5b 00 	movl   $0x5b2d,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 77 0a 00 00       	call   4185 <printf>
      exit();
    370e:	e8 b2 08 00 00       	call   3fc5 <exit>
bsstest(void)
{
  int i;
  ...
  printf(stdout, "bss test ok\n");
    ...
    3726:	c7 44 24 04 3e 5b 00 	movl   $0x5b3e,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 4f 0a 00 00       	call   4185 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 4b 5b 00 00 	movl   $0x5b4b,(%esp)
    3745:	e8 cb 08 00 00       	call   4015 <unlink>
  pid = fork();
    374a:	e8 6e 08 00 00       	call   3fbd <fork>
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 e0 64 00 00 	movl   $0x5b58,0x64e0(,%eax,4)
    376f:	58 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    378c:	c7 44 24 04 35 5c 00 	movl   $0x5c35,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 e9 09 00 00       	call   4185 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 e0 64 00 	movl   $0x64e0,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 54 45 00 00 	movl   $0x4554,(%esp)
    37ab:	e8 4d 08 00 00       	call   3ffd <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 a8 64 00 00       	mov    0x64a8,%eax
    37b5:	c7 44 24 04 42 5c 00 	movl   $0x5c42,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 c0 09 00 00       	call   4185 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 4b 5b 00 00 	movl   $0x5b4b,(%esp)
    37d4:	e8 2c 08 00 00       	call   4005 <open>
    37d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    close(fd);
    37dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
    37df:	89 04 24             	mov    %eax,(%esp)
    37e2:	e8 06 08 00 00       	call   3fed <close>
    exit();
    37e7:	e8 d9 07 00 00       	call   3fc5 <exit>
  } else if(pid < 0){
    37ec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    37f0:	79 1a                	jns    380c <bigargtest+0xd4>
    printf(stdout, "bigargtest: fork failed\n");
    37f2:	a1 a8 64 00 00       	mov    0x64a8,%eax
    37f7:	c7 44 24 04 52 5c 00 	movl   $0x5c52,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 7e 09 00 00       	call   4185 <printf>
    exit();
    3807:	e8 b9 07 00 00       	call   3fc5 <exit>
  }
  wait();
    380c:	e8 bc 07 00 00       	call   3fcd <wait>
  fd = open("bigarg-ok", 0);
    3811:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3818:	00 
    3819:	c7 04 24 4b 5b 00 00 	movl   $0x5b4b,(%esp)
    3820:	e8 e0 07 00 00       	call   4005 <open>
  ...
  if(fd < 0){
    ...
    3833:	c7 44 24 04 6b 5c 00 	movl   $0x5c6b,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 42 09 00 00       	call   4185 <printf>
    exit();
    3843:	e8 7d 07 00 00       	call   3fc5 <exit>
  }
  close(fd);
    3848:	8b 45 ec             	mov    -0x14(%ebp),%eax
    384b:	89 04 24             	mov    %eax,(%esp)
    384e:	e8 9a 07 00 00       	call   3fed <close>
  unlink("bigarg-ok");
    3853:	c7 04 24 4b 5b 00 00 	movl   $0x5b4b,(%esp)
    385a:	e8 b6 07 00 00       	call   4015 <unlink>
}
    385f:	c9                   	leave  
    3860:	c3                   	ret    
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 80 5c 00 	movl   $0x5c80,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 02 09 00 00       	call   4185 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3990:	c7 44 24 04 99 5c 00 	movl   $0x5c99,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 e1 07 00 00       	call   4185 <printf>
      break;
    ...
    39c3:	e8 1d 06 00 00       	call   3fe5 <write>
    ...
    39dc:	c7 44 24 04 a9 5c 00 	movl   $0x5ca9,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 95 07 00 00       	call   4185 <printf>
    close(fd);
    39f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    39f3:	89 04 24             	mov    %eax,(%esp)
    39f6:	e8 f2 05 00 00       	call   3fed <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3aed:	e8 23 05 00 00       	call   4015 <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 b9 5c 00 	movl   $0x5cb9,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 71 06 00 00       	call   4185 <printf>
}
...
testgiduid(void)
{
	...
	uid = getuid();
    3b20:	e8 50 05 00 00       	call   4075 <getuid>
    3b25:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf(2, "Current UID is : %d\n", uid);
    3b28:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3b2b:	89 44 24 08          	mov    %eax,0x8(%esp)
    3b2f:	c7 44 24 04 cf 5c 00 	movl   $0x5ccf,0x4(%esp)
    3b36:	00 
    3b37:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3b3e:	e8 42 06 00 00       	call   4185 <printf>
	printf(2, "Setting UID to 100\n");
    3b43:	c7 44 24 04 e4 5c 00 	movl   $0x5ce4,0x4(%esp)
    3b4a:	00 
    3b4b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3b52:	e8 2e 06 00 00       	call   4185 <printf>
	setuid(100);
    3b57:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
    3b5e:	e8 2a 05 00 00       	call   408d <setuid>
	uid = getuid();
    3b63:	e8 0d 05 00 00       	call   4075 <getuid>
    3b68:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf(2, "Current UID is : %d\n", uid);
    3b6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3b6e:	89 44 24 08          	mov    %eax,0x8(%esp)
    3b72:	c7 44 24 04 cf 5c 00 	movl   $0x5ccf,0x4(%esp)
    3b79:	00 
    3b7a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3b81:	e8 ff 05 00 00       	call   4185 <printf>

	gid = getgid();
    3b86:	e8 f2 04 00 00       	call   407d <getgid>
    3b8b:	89 45 f0             	mov    %eax,-0x10(%ebp)
	printf(2, "Current GID is : %d\n", gid);
    3b8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3b91:	89 44 24 08          	mov    %eax,0x8(%esp)
    3b95:	c7 44 24 04 f8 5c 00 	movl   $0x5cf8,0x4(%esp)
    3b9c:	00 
    3b9d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3ba4:	e8 dc 05 00 00       	call   4185 <printf>
	printf(2, "Setting GID to 100\n");
    3ba9:	c7 44 24 04 0d 5d 00 	movl   $0x5d0d,0x4(%esp)
    3bb0:	00 
    3bb1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bb8:	e8 c8 05 00 00       	call   4185 <printf>
	setgid(100);
    3bbd:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
    3bc4:	e8 cc 04 00 00       	call   4095 <setgid>
	gid = getgid();
    3bc9:	e8 af 04 00 00       	call   407d <getgid>
    3bce:	89 45 f0             	mov    %eax,-0x10(%ebp)
	printf(2, "Current UID is : %d\n", gid);
    3bd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3bd4:	89 44 24 08          	mov    %eax,0x8(%esp)
    3bd8:	c7 44 24 04 cf 5c 00 	movl   $0x5ccf,0x4(%esp)
    3bdf:	00 
    3be0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3be7:	e8 99 05 00 00       	call   4185 <printf>

	ppid = getppid();
    3bec:	e8 94 04 00 00       	call   4085 <getppid>
    3bf1:	89 45 ec             	mov    %eax,-0x14(%ebp)
	printf(2, "My parent process is : %d\n", ppid);
    3bf4:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3bf7:	89 44 24 08          	mov    %eax,0x8(%esp)
    3bfb:	c7 44 24 04 21 5d 00 	movl   $0x5d21,0x4(%esp)
    3c02:	00 
    3c03:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3c0a:	e8 76 05 00 00       	call   4185 <printf>
	printf(2, "Done!\n");
    3c0f:	c7 44 24 04 3c 5d 00 	movl   $0x5d3c,0x4(%esp)
    3c16:	00 
    3c17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3c1e:	e8 62 05 00 00       	call   4185 <printf>

	return 0;
    3c23:	b8 00 00 00 00       	mov    $0x0,%eax
}
    3c28:	c9                   	leave  
    3c29:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c2d:	a1 ac 64 00 00       	mov    0x64ac,%eax
    3c32:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c38:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c3d:	a3 ac 64 00 00       	mov    %eax,0x64ac
  return randstate;
    3c42:	a1 ac 64 00 00       	mov    0x64ac,%eax
}
    3c47:	5d                   	pop    %ebp
    3c48:	c3                   	ret    
...
main(int argc, char *argv[])
{
    ...
    3c4c:	83 e4 f0             	and    $0xfffffff0,%esp
    3c4f:	83 ec 10             	sub    $0x10,%esp
  printf(1, "usertests starting\n");
    3c52:	c7 44 24 04 43 5d 00 	movl   $0x5d43,0x4(%esp)
    3c59:	00 
    3c5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c61:	e8 1f 05 00 00       	call   4185 <printf>

  if(open("usertests.ran", 0) >= 0){
    3c66:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3c6d:	00 
    3c6e:	c7 04 24 57 5d 00 00 	movl   $0x5d57,(%esp)
    3c75:	e8 8b 03 00 00       	call   4005 <open>
    3c7a:	85 c0                	test   %eax,%eax
    3c7c:	78 19                	js     3c97 <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
    3c7e:	c7 44 24 04 68 5d 00 	movl   $0x5d68,0x4(%esp)
    3c85:	00 
    3c86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c8d:	e8 f3 04 00 00       	call   4185 <printf>
    exit();
    3c92:	e8 2e 03 00 00       	call   3fc5 <exit>
  }
  close(open("usertests.ran", O_CREATE));
    3c97:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3c9e:	00 
    3c9f:	c7 04 24 57 5d 00 00 	movl   $0x5d57,(%esp)
    3ca6:	e8 5a 03 00 00       	call   4005 <open>
    3cab:	89 04 24             	mov    %eax,(%esp)
    3cae:	e8 3a 03 00 00       	call   3fed <close>

  createdelete();
    3cb3:	e8 ca d5 ff ff       	call   1282 <createdelete>
  linkunlink();
    3cb8:	e8 0e e0 ff ff       	call   1ccb <linkunlink>
  concreate();
    3cbd:	e8 56 dc ff ff       	call   1918 <concreate>
  fourfiles();
    3cc2:	e8 53 d3 ff ff       	call   101a <fourfiles>
  sharedfd();
    3cc7:	e8 50 d1 ff ff       	call   e1c <sharedfd>

  bigargtest();
    3ccc:	e8 67 fa ff ff       	call   3738 <bigargtest>
  bigwrite();
    3cd1:	e8 d6 e9 ff ff       	call   26ac <bigwrite>
  bigargtest();
    3cd6:	e8 5d fa ff ff       	call   3738 <bigargtest>
  bsstest();
    3cdb:	e8 e6 f9 ff ff       	call   36c6 <bsstest>
  sbrktest();
    3ce0:	e8 02 f4 ff ff       	call   30e7 <sbrktest>
  validatetest();
    3ce5:	e8 0f f9 ff ff       	call   35f9 <validatetest>

  opentest();
    3cea:	e8 d8 c5 ff ff       	call   2c7 <opentest>
  writetest();
    3cef:	e8 7e c6 ff ff       	call   372 <writetest>
  writetest1();
    3cf4:	e8 8e c8 ff ff       	call   587 <writetest1>
  createtest();
    3cf9:	e8 94 ca ff ff       	call   792 <createtest>

  openiputtest();
    3cfe:	e8 c3 c4 ff ff       	call   1c6 <openiputtest>
  exitiputtest();
    3d03:	e8 d2 c3 ff ff       	call   da <exitiputtest>
  iputtest();
    3d08:	e8 f3 c2 ff ff       	call   0 <iputtest>

  mem();
    3d0d:	e8 25 d0 ff ff       	call   d37 <mem>
  pipe1();
    3d12:	e8 5c cc ff ff       	call   973 <pipe1>
  preempt();
    3d17:	e8 44 ce ff ff       	call   b60 <preempt>
  exitwait();
    3d1c:	e8 98 cf ff ff       	call   cb9 <exitwait>

  rmdot();
    3d21:	e8 0f ee ff ff       	call   2b35 <rmdot>
  fourteen();
    3d26:	e8 b4 ec ff ff       	call   29df <fourteen>
  bigfile();
    3d2b:	e8 84 ea ff ff       	call   27b4 <bigfile>
  subdir();
    3d30:	e8 31 e2 ff ff       	call   1f66 <subdir>
  linktest();
    3d35:	e8 95 d9 ff ff       	call   16cf <linktest>
  unlinkread();
    3d3a:	e8 bb d7 ff ff       	call   14fa <unlinkread>
  dirfile();
    3d3f:	e8 69 ef ff ff       	call   2cad <dirfile>
  iref();
    3d44:	e8 a6 f1 ff ff       	call   2eef <iref>
  forktest();
    3d49:	e8 c5 f2 ff ff       	call   3013 <forktest>
  bigdir(); // slow
    3d4e:	e8 a6 e0 ff ff       	call   1df9 <bigdir>
  exectest();
    3d53:	e8 cc cb ff ff       	call   924 <exectest>

  exit();
    3d58:	e8 68 02 00 00       	call   3fc5 <exit>
...
{
    3d5d:	55                   	push   %ebp
    3d5e:	89 e5                	mov    %esp,%ebp
    3d60:	57                   	push   %edi
    3d61:	53                   	push   %ebx
  asm volatile("cld; rep stosb" :
    3d62:	8b 4d 08             	mov    0x8(%ebp),%ecx
    3d65:	8b 55 10             	mov    0x10(%ebp),%edx
    3d68:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d6b:	89 cb                	mov    %ecx,%ebx
    3d6d:	89 df                	mov    %ebx,%edi
    3d6f:	89 d1                	mov    %edx,%ecx
    3d71:	fc                   	cld    
    3d72:	f3 aa                	rep stos %al,%es:(%edi)
    3d74:	89 ca                	mov    %ecx,%edx
    3d76:	89 fb                	mov    %edi,%ebx
    3d78:	89 5d 08             	mov    %ebx,0x8(%ebp)
    3d7b:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
strcpy(char *s, char *t)
{
    ...
    3d85:	83 ec 10             	sub    $0x10,%esp
  char *os;

  os = s;
    3d88:	8b 45 08             	mov    0x8(%ebp),%eax
    3d8b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while((*s++ = *t++) != 0)
    3d8e:	90                   	nop
    3d8f:	8b 45 08             	mov    0x8(%ebp),%eax
    3d92:	8d 50 01             	lea    0x1(%eax),%edx
    3d95:	89 55 08             	mov    %edx,0x8(%ebp)
    3d98:	8b 55 0c             	mov    0xc(%ebp),%edx
    3d9b:	8d 4a 01             	lea    0x1(%edx),%ecx
    3d9e:	89 4d 0c             	mov    %ecx,0xc(%ebp)
    3da1:	0f b6 12             	movzbl (%edx),%edx
    3da4:	88 10                	mov    %dl,(%eax)
    3da6:	0f b6 00             	movzbl (%eax),%eax
    3da9:	84 c0                	test   %al,%al
    3dab:	75 e2                	jne    3d8f <strcpy+0xd>
    ;
  return os;
    3dad:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
    3db0:	c9                   	leave  
    3db1:	c3                   	ret    
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    3db5:	eb 08                	jmp    3dbf <strcmp+0xd>
    p++, q++;
    3db7:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    3dbb:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
strcmp(const char *p, const char *q)
{
  while(*p && *p == *q)
    ...
    3dc5:	84 c0                	test   %al,%al
    3dc7:	74 10                	je     3dd9 <strcmp+0x27>
    3dc9:	8b 45 08             	mov    0x8(%ebp),%eax
    3dcc:	0f b6 10             	movzbl (%eax),%edx
    3dcf:	8b 45 0c             	mov    0xc(%ebp),%eax
    3dd2:	0f b6 00             	movzbl (%eax),%eax
    3dd5:	38 c2                	cmp    %al,%dl
    3dd7:	74 de                	je     3db7 <strcmp+0x5>
    p++, q++;
  return (uchar)*p - (uchar)*q;
    3dd9:	8b 45 08             	mov    0x8(%ebp),%eax
    3ddc:	0f b6 00             	movzbl (%eax),%eax
    3ddf:	0f b6 d0             	movzbl %al,%edx
    3de2:	8b 45 0c             	mov    0xc(%ebp),%eax
    3de5:	0f b6 00             	movzbl (%eax),%eax
    3de8:	0f b6 c0             	movzbl %al,%eax
    3deb:	29 c2                	sub    %eax,%edx
    3ded:	89 d0                	mov    %edx,%eax
}
    3def:	5d                   	pop    %ebp
    3df0:	c3                   	ret    
...
{
    3df1:	55                   	push   %ebp
    3df2:	89 e5                	mov    %esp,%ebp
    3df4:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
    3df7:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    3dfe:	eb 04                	jmp    3e04 <strlen+0x13>
    3e00:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    3e04:	8b 55 fc             	mov    -0x4(%ebp),%edx
    3e07:	8b 45 08             	mov    0x8(%ebp),%eax
    3e0a:	01 d0                	add    %edx,%eax
    3e0c:	0f b6 00             	movzbl (%eax),%eax
    3e0f:	84 c0                	test   %al,%al
    3e11:	75 ed                	jne    3e00 <strlen+0xf>
    ;
  return n;
...
memset(void *dst, int c, uint n)
{
  ...
  stosb(dst, c, n);
    3e1e:	8b 45 10             	mov    0x10(%ebp),%eax
    ...
    3e2f:	89 04 24             	mov    %eax,(%esp)
    3e32:	e8 26 ff ff ff       	call   3d5d <stosb>
  return dst;
...
{
    3e3c:	55                   	push   %ebp
    3e3d:	89 e5                	mov    %esp,%ebp
    3e3f:	83 ec 04             	sub    $0x4,%esp
    3e42:	8b 45 0c             	mov    0xc(%ebp),%eax
    3e45:	88 45 fc             	mov    %al,-0x4(%ebp)
  for(; *s; s++)
    3e48:	eb 14                	jmp    3e5e <strchr+0x22>
    if(*s == c)
    3e4a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e4d:	0f b6 00             	movzbl (%eax),%eax
    3e50:	3a 45 fc             	cmp    -0x4(%ebp),%al
    3e53:	75 05                	jne    3e5a <strchr+0x1e>
      return (char*)s;
    3e55:	8b 45 08             	mov    0x8(%ebp),%eax
    3e58:	eb 13                	jmp    3e6d <strchr+0x31>
}
...
gets(char *buf, int max)
{
    ...
    3e72:	83 ec 28             	sub    $0x28,%esp
  int i, cc;
  char c;

  for(i=0; i+1 < max; ){
    3e75:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3e7c:	eb 4c                	jmp    3eca <gets+0x5b>
    cc = read(0, &c, 1);
    3e7e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3e85:	00 
    3e86:	8d 45 ef             	lea    -0x11(%ebp),%eax
    3e89:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e8d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3e94:	e8 44 01 00 00       	call   3fdd <read>
    3e99:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(cc < 1)
    3e9c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3ea0:	7f 02                	jg     3ea4 <gets+0x35>
      break;
    3ea2:	eb 31                	jmp    3ed5 <gets+0x66>
    buf[i++] = c;
    3ea4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ea7:	8d 50 01             	lea    0x1(%eax),%edx
    3eaa:	89 55 f4             	mov    %edx,-0xc(%ebp)
    3ead:	89 c2                	mov    %eax,%edx
    3eaf:	8b 45 08             	mov    0x8(%ebp),%eax
    3eb2:	01 c2                	add    %eax,%edx
    3eb4:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3eb8:	88 02                	mov    %al,(%edx)
    if(c == '\n' || c == '\r')
    3eba:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3ebe:	3c 0a                	cmp    $0xa,%al
    3ec0:	74 13                	je     3ed5 <gets+0x66>
    3ec2:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3ec6:	3c 0d                	cmp    $0xd,%al
    3ec8:	74 0b                	je     3ed5 <gets+0x66>
gets(char *buf, int max)
{
  int i, cc;
  char c;
  ...
  for(i=0; i+1 < max; ){
    ...
    3ecd:	83 c0 01             	add    $0x1,%eax
    3ed0:	3b 45 0c             	cmp    0xc(%ebp),%eax
    3ed3:	7c a9                	jl     3e7e <gets+0xf>
      break;
    buf[i++] = c;
    if(c == '\n' || c == '\r')
      break;
  ...
  buf[i] = '\0';
    3ed5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3ed8:	8b 45 08             	mov    0x8(%ebp),%eax
    3edb:	01 d0                	add    %edx,%eax
    3edd:	c6 00 00             	movb   $0x0,(%eax)
  return buf;
...
{
    3ee5:	55                   	push   %ebp
    3ee6:	89 e5                	mov    %esp,%ebp
    3ee8:	83 ec 28             	sub    $0x28,%esp
  int fd;
  int r;

  fd = open(n, O_RDONLY);
    3eeb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3ef2:	00 
    3ef3:	8b 45 08             	mov    0x8(%ebp),%eax
    3ef6:	89 04 24             	mov    %eax,(%esp)
    3ef9:	e8 07 01 00 00       	call   4005 <open>
    3efe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0)
    3f01:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3f05:	79 07                	jns    3f0e <stat+0x29>
    return -1;
    3f07:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3f0c:	eb 23                	jmp    3f31 <stat+0x4c>
  r = fstat(fd, st);
    3f0e:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f11:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f15:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3f18:	89 04 24             	mov    %eax,(%esp)
    3f1b:	e8 fd 00 00 00       	call   401d <fstat>
    3f20:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
    3f23:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3f26:	89 04 24             	mov    %eax,(%esp)
    3f29:	e8 bf 00 00 00       	call   3fed <close>
  return r;
    3f2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
    3f31:	c9                   	leave  
    3f32:	c3                   	ret    
...
atoi(const char *s)
{
  ...
  n = 0;
    3f39:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while('0' <= *s && *s <= '9')
    3f40:	eb 25                	jmp    3f67 <atoi+0x34>
    n = n*10 + *s++ - '0';
    3f42:	8b 55 fc             	mov    -0x4(%ebp),%edx
    3f45:	89 d0                	mov    %edx,%eax
    3f47:	c1 e0 02             	shl    $0x2,%eax
    3f4a:	01 d0                	add    %edx,%eax
    3f4c:	01 c0                	add    %eax,%eax
    3f4e:	89 c1                	mov    %eax,%ecx
    3f50:	8b 45 08             	mov    0x8(%ebp),%eax
    3f53:	8d 50 01             	lea    0x1(%eax),%edx
    3f56:	89 55 08             	mov    %edx,0x8(%ebp)
    3f59:	0f b6 00             	movzbl (%eax),%eax
    3f5c:	0f be c0             	movsbl %al,%eax
    3f5f:	01 c8                	add    %ecx,%eax
    3f61:	83 e8 30             	sub    $0x30,%eax
    3f64:	89 45 fc             	mov    %eax,-0x4(%ebp)
atoi(const char *s)
{
  int n;
  ...
  while('0' <= *s && *s <= '9')
    ...
    3f6a:	0f b6 00             	movzbl (%eax),%eax
    3f6d:	3c 2f                	cmp    $0x2f,%al
    3f6f:	7e 0a                	jle    3f7b <atoi+0x48>
    3f71:	8b 45 08             	mov    0x8(%ebp),%eax
    3f74:	0f b6 00             	movzbl (%eax),%eax
    3f77:	3c 39                	cmp    $0x39,%al
    3f79:	7e c7                	jle    3f42 <atoi+0xf>
    n = n*10 + *s++ - '0';
  return n;
...
memmove(void *vdst, void *vsrc, int n)
{
  ...
  while(n-- > 0)
    3f92:	eb 17                	jmp    3fab <memmove+0x2b>
    *dst++ = *src++;
    3f94:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f97:	8d 50 01             	lea    0x1(%eax),%edx
    3f9a:	89 55 fc             	mov    %edx,-0x4(%ebp)
    3f9d:	8b 55 f8             	mov    -0x8(%ebp),%edx
    3fa0:	8d 4a 01             	lea    0x1(%edx),%ecx
    3fa3:	89 4d f8             	mov    %ecx,-0x8(%ebp)
    3fa6:	0f b6 12             	movzbl (%edx),%edx
    3fa9:	88 10                	mov    %dl,(%eax)
{
  ...
  while(n-- > 0)
    ...
    3fb6:	7f dc                	jg     3f94 <memmove+0x14>
    *dst++ = *src++;
  return vdst;
...
SYSCALL(fork)
    3fbd:	b8 01 00 00 00       	mov    $0x1,%eax
    3fc2:	cd 40                	int    $0x40
    3fc4:	c3                   	ret    

00003fc5 <exit>:
SYSCALL(exit)
    3fc5:	b8 02 00 00 00       	mov    $0x2,%eax
    3fca:	cd 40                	int    $0x40
    3fcc:	c3                   	ret    

00003fcd <wait>:
SYSCALL(wait)
    3fcd:	b8 03 00 00 00       	mov    $0x3,%eax
    3fd2:	cd 40                	int    $0x40
    3fd4:	c3                   	ret    

00003fd5 <pipe>:
SYSCALL(pipe)
    3fd5:	b8 04 00 00 00       	mov    $0x4,%eax
    3fda:	cd 40                	int    $0x40
    3fdc:	c3                   	ret    

00003fdd <read>:
SYSCALL(read)
    3fdd:	b8 05 00 00 00       	mov    $0x5,%eax
    3fe2:	cd 40                	int    $0x40
    3fe4:	c3                   	ret    

00003fe5 <write>:
SYSCALL(write)
    3fe5:	b8 10 00 00 00       	mov    $0x10,%eax
    3fea:	cd 40                	int    $0x40
    3fec:	c3                   	ret    

00003fed <close>:
SYSCALL(close)
    3fed:	b8 15 00 00 00       	mov    $0x15,%eax
    3ff2:	cd 40                	int    $0x40
    3ff4:	c3                   	ret    

00003ff5 <kill>:
SYSCALL(kill)
    3ff5:	b8 06 00 00 00       	mov    $0x6,%eax
    3ffa:	cd 40                	int    $0x40
    3ffc:	c3                   	ret    

00003ffd <exec>:
SYSCALL(exec)
    3ffd:	b8 07 00 00 00       	mov    $0x7,%eax
    4002:	cd 40                	int    $0x40
    4004:	c3                   	ret    

00004005 <open>:
SYSCALL(open)
    4005:	b8 0f 00 00 00       	mov    $0xf,%eax
    400a:	cd 40                	int    $0x40
    400c:	c3                   	ret    

0000400d <mknod>:
SYSCALL(mknod)
    400d:	b8 11 00 00 00       	mov    $0x11,%eax
    4012:	cd 40                	int    $0x40
    4014:	c3                   	ret    

00004015 <unlink>:
SYSCALL(unlink)
    4015:	b8 12 00 00 00       	mov    $0x12,%eax
    401a:	cd 40                	int    $0x40
    401c:	c3                   	ret    

0000401d <fstat>:
SYSCALL(fstat)
    401d:	b8 08 00 00 00       	mov    $0x8,%eax
    4022:	cd 40                	int    $0x40
    4024:	c3                   	ret    

00004025 <link>:
SYSCALL(link)
    4025:	b8 13 00 00 00       	mov    $0x13,%eax
    402a:	cd 40                	int    $0x40
    402c:	c3                   	ret    

0000402d <mkdir>:
SYSCALL(mkdir)
    402d:	b8 14 00 00 00       	mov    $0x14,%eax
    4032:	cd 40                	int    $0x40
    4034:	c3                   	ret    

00004035 <chdir>:
SYSCALL(chdir)
    4035:	b8 09 00 00 00       	mov    $0x9,%eax
    403a:	cd 40                	int    $0x40
    403c:	c3                   	ret    

0000403d <dup>:
SYSCALL(dup)
    403d:	b8 0a 00 00 00       	mov    $0xa,%eax
    4042:	cd 40                	int    $0x40
    4044:	c3                   	ret    

00004045 <getpid>:
SYSCALL(getpid)
    4045:	b8 0b 00 00 00       	mov    $0xb,%eax
    404a:	cd 40                	int    $0x40
    404c:	c3                   	ret    

0000404d <sbrk>:
SYSCALL(sbrk)
    404d:	b8 0c 00 00 00       	mov    $0xc,%eax
    4052:	cd 40                	int    $0x40
    4054:	c3                   	ret    

00004055 <sleep>:
SYSCALL(sleep)
    4055:	b8 0d 00 00 00       	mov    $0xd,%eax
    405a:	cd 40                	int    $0x40
    405c:	c3                   	ret    

0000405d <uptime>:
SYSCALL(uptime)
    405d:	b8 0e 00 00 00       	mov    $0xe,%eax
    4062:	cd 40                	int    $0x40
    4064:	c3                   	ret    

00004065 <halt>:
SYSCALL(halt)
    4065:	b8 16 00 00 00       	mov    $0x16,%eax
    406a:	cd 40                	int    $0x40
    406c:	c3                   	ret    

0000406d <date>:
SYSCALL(date)
    406d:	b8 17 00 00 00       	mov    $0x17,%eax
    4072:	cd 40                	int    $0x40
    4074:	c3                   	ret    

00004075 <getuid>:
SYSCALL(getuid)
    4075:	b8 18 00 00 00       	mov    $0x18,%eax
    407a:	cd 40                	int    $0x40
    407c:	c3                   	ret    

0000407d <getgid>:
SYSCALL(getgid)
    407d:	b8 19 00 00 00       	mov    $0x19,%eax
    4082:	cd 40                	int    $0x40
    4084:	c3                   	ret    

00004085 <getppid>:
SYSCALL(getppid)
    4085:	b8 1a 00 00 00       	mov    $0x1a,%eax
    408a:	cd 40                	int    $0x40
    408c:	c3                   	ret    

0000408d <setuid>:
SYSCALL(setuid)
    408d:	b8 1b 00 00 00       	mov    $0x1b,%eax
    4092:	cd 40                	int    $0x40
    4094:	c3                   	ret    

00004095 <setgid>:
SYSCALL(setgid)
    4095:	b8 1c 00 00 00       	mov    $0x1c,%eax
    409a:	cd 40                	int    $0x40
    409c:	c3                   	ret    

0000409d <getprocs>:
SYSCALL(getprocs)
    409d:	b8 1d 00 00 00       	mov    $0x1d,%eax
    40a2:	cd 40                	int    $0x40
    40a4:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    40a8:	83 ec 18             	sub    $0x18,%esp
    40ab:	8b 45 0c             	mov    0xc(%ebp),%eax
    40ae:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40b1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    40b8:	00 
    40b9:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40bc:	89 44 24 04          	mov    %eax,0x4(%esp)
    40c0:	8b 45 08             	mov    0x8(%ebp),%eax
    40c3:	89 04 24             	mov    %eax,(%esp)
    40c6:	e8 1a ff ff ff       	call   3fe5 <write>
}
    40cb:	c9                   	leave  
    40cc:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    40d5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40dc:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40e0:	74 17                	je     40f9 <printint+0x2c>
    40e2:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    40e6:	79 11                	jns    40f9 <printint+0x2c>
    neg = 1;
    40e8:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    40ef:	8b 45 0c             	mov    0xc(%ebp),%eax
    40f2:	f7 d8                	neg    %eax
    40f4:	89 45 ec             	mov    %eax,-0x14(%ebp)
    40f7:	eb 06                	jmp    40ff <printint+0x32>
  } else {
    x = xx;
    40f9:	8b 45 0c             	mov    0xc(%ebp),%eax
    40fc:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    40ff:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4106:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4109:	8d 41 01             	lea    0x1(%ecx),%eax
    410c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    410f:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4112:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4115:	ba 00 00 00 00       	mov    $0x0,%edx
    411a:	f7 f3                	div    %ebx
    411c:	89 d0                	mov    %edx,%eax
    411e:	0f b6 80 b0 64 00 00 	movzbl 0x64b0(%eax),%eax
    4125:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4129:	8b 75 10             	mov    0x10(%ebp),%esi
    412c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    412f:	ba 00 00 00 00       	mov    $0x0,%edx
    4134:	f7 f6                	div    %esi
    4136:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4139:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    413d:	75 c7                	jne    4106 <printint+0x39>
  if(neg)
    413f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4143:	74 10                	je     4155 <printint+0x88>
    buf[i++] = '-';
    4145:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4148:	8d 50 01             	lea    0x1(%eax),%edx
    414b:	89 55 f4             	mov    %edx,-0xc(%ebp)
    414e:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4153:	eb 1f                	jmp    4174 <printint+0xa7>
    4155:	eb 1d                	jmp    4174 <printint+0xa7>
    putc(fd, buf[i]);
    4157:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    416f:	e8 31 ff ff ff       	call   40a5 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4174:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4178:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    417c:	79 d9                	jns    4157 <printint+0x8a>
    putc(fd, buf[i]);
}
    417e:	83 c4 30             	add    $0x30,%esp
    4181:	5b                   	pop    %ebx
    4182:	5e                   	pop    %esi
    4183:	5d                   	pop    %ebp
    4184:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    41a2:	e9 7c 01 00 00       	jmp    4323 <printf+0x19e>
    c = fmt[i] & 0xff;
    ...
    41d0:	e9 4a 01 00 00       	jmp    431f <printf+0x19a>
      } else {
        putc(fd, c);
    41d5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41d8:	0f be c0             	movsbl %al,%eax
    41db:	89 44 24 04          	mov    %eax,0x4(%esp)
    41df:	8b 45 08             	mov    0x8(%ebp),%eax
    41e2:	89 04 24             	mov    %eax,(%esp)
    41e5:	e8 bb fe ff ff       	call   40a5 <putc>
    41ea:	e9 30 01 00 00       	jmp    431f <printf+0x19a>
      }
    } else if(state == '%'){
    41ef:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    41f3:	0f 85 26 01 00 00    	jne    431f <printf+0x19a>
      if(c == 'd'){
    41f9:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    41fd:	75 2d                	jne    422c <printf+0xa7>
        printint(fd, *ap, 10, 1);
    41ff:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4202:	8b 00                	mov    (%eax),%eax
    4204:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    420b:	00 
    420c:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4213:	00 
    4214:	89 44 24 04          	mov    %eax,0x4(%esp)
    4218:	8b 45 08             	mov    0x8(%ebp),%eax
    421b:	89 04 24             	mov    %eax,(%esp)
    421e:	e8 aa fe ff ff       	call   40cd <printint>
        ap++;
    4223:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4227:	e9 ec 00 00 00       	jmp    4318 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    422c:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4230:	74 06                	je     4238 <printf+0xb3>
    4232:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4236:	75 2d                	jne    4265 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4238:	8b 45 e8             	mov    -0x18(%ebp),%eax
    423b:	8b 00                	mov    (%eax),%eax
    423d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4244:	00 
    4245:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    424c:	00 
    424d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4251:	8b 45 08             	mov    0x8(%ebp),%eax
    4254:	89 04 24             	mov    %eax,(%esp)
    4257:	e8 71 fe ff ff       	call   40cd <printint>
        ap++;
    425c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4260:	e9 b3 00 00 00       	jmp    4318 <printf+0x193>
      } else if(c == 's'){
    4265:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4269:	75 45                	jne    42b0 <printf+0x12b>
        s = (char*)*ap;
    426b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    426e:	8b 00                	mov    (%eax),%eax
    4270:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4273:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4277:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    427b:	75 09                	jne    4286 <printf+0x101>
          s = "(null)";
    427d:	c7 45 f4 92 5d 00 00 	movl   $0x5d92,-0xc(%ebp)
        while(*s != 0){
    4284:	eb 1e                	jmp    42a4 <printf+0x11f>
    4286:	eb 1c                	jmp    42a4 <printf+0x11f>
          putc(fd, *s);
    4288:	8b 45 f4             	mov    -0xc(%ebp),%eax
    428b:	0f b6 00             	movzbl (%eax),%eax
    428e:	0f be c0             	movsbl %al,%eax
    4291:	89 44 24 04          	mov    %eax,0x4(%esp)
    4295:	8b 45 08             	mov    0x8(%ebp),%eax
    4298:	89 04 24             	mov    %eax,(%esp)
    429b:	e8 05 fe ff ff       	call   40a5 <putc>
          s++;
    42a0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    42aa:	84 c0                	test   %al,%al
    42ac:	75 da                	jne    4288 <printf+0x103>
    42ae:	eb 68                	jmp    4318 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    42b0:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    42b4:	75 1d                	jne    42d3 <printf+0x14e>
        putc(fd, *ap);
    42b6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42b9:	8b 00                	mov    (%eax),%eax
    42bb:	0f be c0             	movsbl %al,%eax
    42be:	89 44 24 04          	mov    %eax,0x4(%esp)
    42c2:	8b 45 08             	mov    0x8(%ebp),%eax
    42c5:	89 04 24             	mov    %eax,(%esp)
    42c8:	e8 d8 fd ff ff       	call   40a5 <putc>
        ap++;
    42cd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42d1:	eb 45                	jmp    4318 <printf+0x193>
      } else if(c == '%'){
    42d3:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42d7:	75 17                	jne    42f0 <printf+0x16b>
        putc(fd, c);
    42d9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42dc:	0f be c0             	movsbl %al,%eax
    42df:	89 44 24 04          	mov    %eax,0x4(%esp)
    42e3:	8b 45 08             	mov    0x8(%ebp),%eax
    42e6:	89 04 24             	mov    %eax,(%esp)
    42e9:	e8 b7 fd ff ff       	call   40a5 <putc>
    42ee:	eb 28                	jmp    4318 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    42f0:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    42f7:	00 
    42f8:	8b 45 08             	mov    0x8(%ebp),%eax
    42fb:	89 04 24             	mov    %eax,(%esp)
    42fe:	e8 a2 fd ff ff       	call   40a5 <putc>
        putc(fd, c);
    4303:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4306:	0f be c0             	movsbl %al,%eax
    4309:	89 44 24 04          	mov    %eax,0x4(%esp)
    430d:	8b 45 08             	mov    0x8(%ebp),%eax
    4310:	89 04 24             	mov    %eax,(%esp)
    4313:	e8 8d fd ff ff       	call   40a5 <putc>
      }
      state = 0;
    4318:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    431f:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4323:	8b 55 0c             	mov    0xc(%ebp),%edx
    4326:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4329:	01 d0                	add    %edx,%eax
    432b:	0f b6 00             	movzbl (%eax),%eax
    432e:	84 c0                	test   %al,%al
    4330:	0f 85 71 fe ff ff    	jne    41a7 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    43d6:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43e0:	01 d0                	add    %edx,%eax
    43e2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43e5:	75 20                	jne    4407 <free+0xcf>
    p->s.size += bp->s.size;
    43e7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ea:	8b 50 04             	mov    0x4(%eax),%edx
    43ed:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43f0:	8b 40 04             	mov    0x4(%eax),%eax
    43f3:	01 c2                	add    %eax,%edx
    ...
    4405:	eb 08                	jmp    440f <free+0xd7>
  } else
    p->s.ptr = bp;
    4407:	8b 45 fc             	mov    -0x4(%ebp),%eax
    440a:	8b 55 f8             	mov    -0x8(%ebp),%edx
    440d:	89 10                	mov    %edx,(%eax)
  freep = p;
    440f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4412:	a3 68 65 00 00       	mov    %eax,0x6568
}
    4417:	c9                   	leave  
    4418:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    441c:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    441f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4426:	77 07                	ja     442f <morecore+0x16>
    nu = 4096;
    4428:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    442f:	8b 45 08             	mov    0x8(%ebp),%eax
    4432:	c1 e0 03             	shl    $0x3,%eax
    4435:	89 04 24             	mov    %eax,(%esp)
    4438:	e8 10 fc ff ff       	call   404d <sbrk>
    443d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4440:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4444:	75 07                	jne    444d <morecore+0x34>
    return 0;
    4446:	b8 00 00 00 00       	mov    $0x0,%eax
    444b:	eb 22                	jmp    446f <morecore+0x56>
  hp = (Header*)p;
    444d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4450:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4453:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4456:	8b 55 08             	mov    0x8(%ebp),%edx
    4459:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    445c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    445f:	83 c0 08             	add    $0x8,%eax
    4462:	89 04 24             	mov    %eax,(%esp)
    4465:	e8 ce fe ff ff       	call   4338 <free>
  return freep;
    446a:	a1 68 65 00 00       	mov    0x6568,%eax
}
    446f:	c9                   	leave  
    4470:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4474:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4477:	8b 45 08             	mov    0x8(%ebp),%eax
    447a:	83 c0 07             	add    $0x7,%eax
    447d:	c1 e8 03             	shr    $0x3,%eax
    4480:	83 c0 01             	add    $0x1,%eax
    4483:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4486:	a1 68 65 00 00       	mov    0x6568,%eax
    448b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    448e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4492:	75 23                	jne    44b7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4494:	c7 45 f0 60 65 00 00 	movl   $0x6560,-0x10(%ebp)
    449b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    449e:	a3 68 65 00 00       	mov    %eax,0x6568
    44a3:	a1 68 65 00 00       	mov    0x6568,%eax
    44a8:	a3 60 65 00 00       	mov    %eax,0x6560
    base.s.size = 0;
    44ad:	c7 05 64 65 00 00 00 	movl   $0x0,0x6564
    44b4:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    44b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44ba:	8b 00                	mov    (%eax),%eax
    44bc:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    44bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44c2:	8b 40 04             	mov    0x4(%eax),%eax
    44c5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44c8:	72 4d                	jb     4517 <malloc+0xa6>
      if(p->s.size == nunits)
    44ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44cd:	8b 40 04             	mov    0x4(%eax),%eax
    44d0:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44d3:	75 0c                	jne    44e1 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    44d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44d8:	8b 10                	mov    (%eax),%edx
    44da:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44dd:	89 10                	mov    %edx,(%eax)
    44df:	eb 26                	jmp    4507 <malloc+0x96>
      else {
        p->s.size -= nunits;
    44e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44e4:	8b 40 04             	mov    0x4(%eax),%eax
    44e7:	2b 45 ec             	sub    -0x14(%ebp),%eax
    44ea:	89 c2                	mov    %eax,%edx
    44ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44ef:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    44f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44f5:	8b 40 04             	mov    0x4(%eax),%eax
    44f8:	c1 e0 03             	shl    $0x3,%eax
    44fb:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    44fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4501:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4504:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4507:	8b 45 f0             	mov    -0x10(%ebp),%eax
    450a:	a3 68 65 00 00       	mov    %eax,0x6568
      return (void*)(p + 1);
    450f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4512:	83 c0 08             	add    $0x8,%eax
    4515:	eb 38                	jmp    454f <malloc+0xde>
    }
    if(p == freep)
    4517:	a1 68 65 00 00       	mov    0x6568,%eax
    451c:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    451f:	75 1b                	jne    453c <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4521:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4524:	89 04 24             	mov    %eax,(%esp)
    4527:	e8 ed fe ff ff       	call   4419 <morecore>
    452c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    452f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4533:	75 07                	jne    453c <malloc+0xcb>
        return 0;
    4535:	b8 00 00 00 00       	mov    $0x0,%eax
    453a:	eb 13                	jmp    454f <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    453f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4542:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4545:	8b 00                	mov    (%eax),%eax
    ...
    454a:	e9 70 ff ff ff       	jmp    44bf <malloc+0x4e>
}
    454f:	c9                   	leave  
    4550:	c3                   	ret    
